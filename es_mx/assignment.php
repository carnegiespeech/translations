...
/**
 * Strings for component 'assignment', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   assignment
...
$string['messageprovider:assignment_updates'] = 'Notficaciones de Tarea';
...
$string['trackdrafts_help'] = '<p>El botón "Enviar para que sea calificada" permite a los usuarios avisar a los evaluadores que han terminado de trabajar en una tarea. Los evaluadores pueden elegir si devuelven la tarea al estatus de borrador (por ejemplo, si necesita mejorar).</p>';
