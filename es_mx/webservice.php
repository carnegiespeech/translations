...
/**
 * Strings for component 'webservice', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   webservice
...
$string['accesstofunctionnotallowed'] = 'No se permite el acceso a la función {$a}(). Por favor revise si está habilitado algún servicio que contenga esta función. En las configuraciones del servicio: si el servicio está restringido, revise que el usuario esté enlistado. Dentro de la misma configuración del servicio revise si hubiera restricciones por IP o si el servicio requiere de alguna capacidad.';
...
$string['createtokenforuserauto'] = 'Autocrear una ficha (token) para un usuario';
...
$string['enabledirectdownload'] = 'Debe habilitarse la descarga de archivos de servicio Web en las configuraciones del servicio externo';
...
$string['enablemobilewsoverview'] = 'Vaya a la página de administración {$a->manageservicelink}, elija la configuración "{$a->enablemobileservice}" y guárdela. Todo se configurará para Usted y todos los usuarios del sitio podrán emplear la App oficial de Moodle. Estatus actual: {$a->wsmobilestatus}';
...
$string['invalidtokensession'] = 'Token (ficha) basada de sesión inválida - no se encontró o caducó la sesión';
...
$string['protocolnotallowed'] = 'A  Usted no se le permite usar el protocolo {$a} (le falta la capacidad: webservice/{$a}:use)';
...
$string['wsauthmissing'] = 'Falta el plugin de autenticación de servicio web';
$string['wsauthnotenabled'] = 'Está deshabilitado el plugin de autenticación de servicio web';
