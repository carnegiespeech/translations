...
/**
 * Strings for component 'block_recommender', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
...
$string['activity_filter_activities'] = 'Todas las Actividades';
$string['activity_filter_activity'] = 'Actividad:';
$string['activity_filter_activity_help'] = '<p>Usted puede filtrar los resultados en la tabla debajo controlando el recurso y/o la actividad incluida.</p> <p>Por defecto, todas las actividades y recursos están incluidos dentro de la tabla de resultados.</p> <p>Si Usted desea solamente ver recursos que hayan sido vistos (estos serían archivos y páginas de recursos), u otras actividades (estos serían por ejemplo, foro, wiki, glosario o blog), Usted puede emplear la lista desplegable para elegir entre las siguientes tres opciones:</p> <ol><li>Todos</li><li>Solamente Recursos</li><li>Solamente Actividades</li></ol><p>Por favor observe que si su sitio web no incluye alguno de los tipos de recursos o actividades superiores, la opción de filtro no estará disponible.</p> <p>Si Usted navega lejos de la página, sus opciones de filtro regresarán a las opciones por defecto.</p>';
...
$string['activity_filter_resources'] = 'Todos los Recursos';
...
$string['activity_servicetitle'] = 'Actividades populares en este sitio web';
$string['activity_sort'] = 'Resultados de Actividades Populares';
...
$string['oer_disclaimer'] = 'Las ligas hacia OpenCourseWare links son proporcionadas por el Recomendador de OER. La Universidad Abierta (del UK) no es responsable por la disponibilidad o contenido de los sitios de internet externos.';
$string['oer_indexed'] = 'Indexado por Recomendador OER';
$string['oer_indexeddescription'] = 'Palomear si es que el sitio es indexado por el servicio Recomendador OER. <a href="http://www.folksemantic.com/feeds/new_oai_rss">Registrar este sitio.</a>';
$string['oer_noresults'] = 'No se encontraron recursos de OER relevantes.';
$string['oer_servicetitle'] = 'Recursos Educacionales Abiertos (OER=Open Educational Resources)';
$string['oer_xmlloadfailed'] = 'Falló al buscar datos de OER';
...
$string['recommendertitle_help'] = '<p>Este bloque le permite ver la actividad más reciente de otros usuarios de este sitio. Usted puede ver los recursos y actividades más populares que hayan sido vistos y, si fuera apropiado, hayan participado dentro del sitio.</p> <p>Si Usted elige en la liga inferior para \'Actividades populares en este sitio\' Usted verá los tres resultados superiores (Usted puede elegir alguno para ir directamente a ese recurso o actividad enlistado) y habrá una liga hacia \'más\', donde Usted podrá acceder a una página donde estarán enlistados todos los resultados para este sitio web.</p> <p>Usted podrá filtrar los resultados por rango de fechas, tipo de actividad, título del item y por el número de vistas y participaciones.</p>';
...
$string['recommender:viewoer'] = 'Ver servicios de Recomendador OER';
