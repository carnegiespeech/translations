...
/**
 * Strings for component 'rating', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   rating
...
$string['rolewarning_help'] = 'Para enviar valuaciones (ratings), los usuarios necesitan el permiso \'moodle/rating:rate\' y cualquier permisos específicos del módulo. Los usuarios asignados a los roles siguientes deberían poder valuar items. La lista de roles puede ser modificada a través del enlace a permisos en el bloque de configuración.';
