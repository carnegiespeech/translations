...
/**
 * Strings for component 'block_exaport', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
...
$string['bookmarksaved'] = 'Marcador añadido.';
$string['bookmarksavedexternal'] = 'Liga externa añadida.';
$string['bookmarksavedfile'] = 'Archivo añadido.';
$string['bookmarksavednote'] = 'Nota añadida.';
...
$string['competenceinteraction'] = 'Permitir interacción con bloque de competencias exabis, en caso de estar instalado';
...
$string['config_version_2'] = 'Antiguo diseño de E-portafolio';
...
$string['desp_bookmarks'] = 'Mi Dosier';
...
$string['desp_explaining'] = 'Mis Artefactos';
$string['desp_explainingfile'] = 'Archivos. Éstos archivos pueden ser compartidos con todos los miembros autorizados del curso.';
$string['desp_explaininglink'] = 'Enlaces. Éstos enlaces pueden ser compartidos con todos los miembros autorizados del curso.';
$string['desp_explainingnote'] = 'Notas. Éstas notas pueden ser compaertidas con todos los miembros autorizados del curso.';
$string['desp_language'] = 'Idioma';
$string['desp_mybookmarks'] = 'Mi Dosier';
$string['desp_pluginname'] = 'Dosier';
$string['desp_sharedbookmarks'] = 'dosiers publicados';
...
$string['exaport:shareextern'] = 'Compartir externamente entradas de portafolios';
$string['exaport:shareintern'] = 'Compartir internamente entradas de portafolios';
...
$string['modulename'] = 'E-Portafolio Exabis';
$string['moodleimport'] = 'Importar desde Moodle-tareas';
$string['movebottom'] = 'Botón Mover';
$string['movetop'] = 'Mover arriba';
$string['mybookmarks'] = 'Mi Portafolios';
$string['mybookmarkstitle'] = 'Módulo de E-Portafolio Exabis: Añada sus ligas y archivos aquí.';
...
$string['pluginname'] = 'E-Portafolio Exabis';
...
$string['settings_interaktion_exacomp_body'] = 'Interacción con el bloque de competencias exabis, en caso de estar instalado';
$string['settings_interaktion_exacomp_head'] = 'Interacción entre competencias exabis y exabis ePortafolio';
...
$string['sharedwith_meand'] = 'Compartido conmigo y con {$a} otros usuarios';
...
$string['version_5.2.0_needed'] = 'El E-Portafolio Exabis requiere al menos PHP Versión 5.2.0';
$string['view'] = 'Vista';
$string['viewand'] = 'y';
