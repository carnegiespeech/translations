...
/**
 * Strings for component 'feedback', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   feedback
...
$string['emailnotification_help'] = 'Si está habilitado, los administradores recibirán notificaciones por correo electrónico de los envíos de retroalimentaciones';
...
$string['feedbackclose'] = 'Cerrar la retroalimentación en';
$string['feedbackcloses'] = 'La retroalimentación se cierra';
...
$string['feedbackopen'] = 'Abrir la retroalimentación';
$string['feedbackopens'] = 'La retroalimentación se abre';
...
$string['modulename_help'] = 'El módulo de retroalimentación le permite al profesor crear encuestas personalizadas';
...
$string['radiobutton'] = 'Opción múltiple - respuesta única permitida (botones de selección)';
$string['radiobutton_rated'] = 'Botón de selección (valorado)';
$string['radiorated'] = 'Botón de selección (valorado)';
...
$string['timeopen_help'] = 'Usted puede especificar las horas en las que está disponible la retroalimentación para responder a las preguntas. Si la casilla de selección no está marcada, no hay límite de tiempo definido.';
...
$string['url_for_continue_help'] = 'De manera predeterminada, cuando se envía una retroalimentación, el botón Continuar lleva a la página del curso. Usted puede definir aquí otra URL de destino para el botón Continuar.';
