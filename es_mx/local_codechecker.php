...
/**
 * Strings for component 'local_codechecker', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
...
$string['numerrorswarnings'] = '{$a->numErrors} error(es) y {$a->numWarnings} advertencia(s)';
