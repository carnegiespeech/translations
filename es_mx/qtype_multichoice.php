...
/**
 * Strings for component 'qtype_multichoice', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
...
$string['shuffleanswers_help'] = 'Si está activado, el orden de las respuestas varía de forma aleatoria en cada intento, siempre que "Barajar dentro de las preguntas" en la configuración de la actividad también esté habilitada.';
