...
/**
 * Strings for component 'enrol', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   enrol
...
$string['deleteinstanceconfirm'] = '¿Realmente desea eliminar la instancia de plugin de inscripción "{$a->name}" con los usuarios inscritos {$a->users}?';
...
$string['noguestaccess'] = 'Los invitados no pueden acceder a este curso, por favor intente ingresar.';
$string['none'] = 'Ninguno';
...
$string['uninstallconfirm'] = 'Está a punto de eliminar completamente el plugin de inscripción \'{$a}\'. Esta acción eliminará completamente toda la información en la base de datos asociada con este tipo de inscripción. ¿Está SEGURO de que desea continuar?';
