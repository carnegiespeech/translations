...
/**
 * Strings for component 'qtype_multinumerical', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
...
$string['noncomputable'] = '(las respuestas correctas no son computables automáticamente)';
