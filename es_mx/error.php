...
/**
 * Strings for component 'error', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   error
...
$string['cannotnetgeo'] = 'No se puede conectar al servidor NeoGeo en http://netgeo.caida.org, por favor revise las configuraciones del proxy o , mejor aún, instale el archivo de datos de MaxMind GeoLite City';
...
$string['invalidgradeitmeid'] = 'ID de item de calificación incorrecto';
...
$string['maxbytes'] = 'Este archivo es mayor que el tamaño máximo';
