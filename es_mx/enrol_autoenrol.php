...
/**
 * Strings for component 'enrol_autoenrol', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
...
$string['unenrolselfconfirm'] = '¿Realmente desea des-inscribirse a sí mismo del curso "{$a}"? Usted puede volver a visitar el curso para volverse a inscribir, pero se perderá la información de sus calificaciones y envíos de tareas.';
