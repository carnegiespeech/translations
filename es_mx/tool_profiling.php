...
/**
 * Strings for component 'tool_profiling', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
...
$string['viewdiff'] = 'Ver diferencias de perfilado (profiling) con la última corrida de referencia';
