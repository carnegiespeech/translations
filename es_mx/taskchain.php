...
/**
 * Strings for component 'taskchain', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   taskchain
...
$string['confirmdeletechainscolumnlist'] = '¿Está Usted seguro de querer eliminar esta lista de columna de cadena?';
...
$string['confirmdeletetaskscolumnlist'] = '¿Está Usted seguro de querer eliminar esta lista de columna de tarea?';
...
$string['showdescription_help'] = 'Si esta configuración está habilitada, el texto de entrada de abajo aparecerá en la página del curso como la decripción para esta actividad.';
