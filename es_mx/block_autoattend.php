...
/**
 * Strings for component 'block_autoattend', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
...
$string['email_teacher_attend'] = 'Anexo a este correo están los datos de asistencia de {$a->fullname} [{$a->date}].';
$string['email_teacher_key'] = 'La palabra clave de {$a->fullname} [{$a->date}] es {$a->key}';
$string['email_teacher_key_html'] = 'La palabra clave de {$a->fullname} [{$a->date}] es <strong>{$a->key}</strong>';
$string['endtime'] = 'Fin';
