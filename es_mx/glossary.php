...
/**
 * Strings for component 'glossary', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   glossary
...
$string['modulename_help'] = 'El módulo glosario permite a los participantes crear y mantener una lista de definiciones, igual que un diccionario. Las entradas del glosario se pueden enlazar automáticamente dondequiera que aparezca en el curso la palabra o frase del concepto.';
