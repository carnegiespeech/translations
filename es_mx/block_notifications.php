...
/**
 * Strings for component 'block_notifications', language 'es_mx', branch 'MOODLE_20_STABLE'
 *
...
$string['email'] = 'Email';
$string['email_icon_tooltip'] = 'La notificación de contenido nuevo mediante Email está habilitada. Usted recibirá unEmail cada';
...
$string['end_of_tooltip'] = 'horas si se añaden nuevos contenidos o atividades al curso';
...
$string['notification_frequency'] = 'Revisar nuevos contenidos, frecuencia en horas:';
$string['notification_frequency_comment'] = 'La revisión del nuevo contenido en cursos se realizará cada cierto número de horas especificado aquí. Este valor puede sobre-escribirse por las configuraciones dentro del curso.';
...
$string['rss'] = 'RSS';
$string['rss_empty_description'] = 'Este RSS está vacío. Espere a que la plataforma escaneee y salga el contenido del curso.';
...
$string['sms_icon_tooltip'] = 'La notificación sobre contenido nuevo mediante SMS está habilitada. Usted recibirá un SMS cada';
