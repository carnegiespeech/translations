...
/**
 * Strings for component 'flashcard', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   flashcard
...
*Imagen: El texto introducido es la localización de un archivo de imágen en el servidor, tomado de los archivos del curso.
