...
/**
 * Strings for component 'lesson', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   lesson
...
$string['importppt_help'] = 'Esta característica habilita importar a una lección un archivo ZIP de presentación PowerPoint  2003 guardado como página web<p> FORMA DE USARLO</p> <p>Todas las diapositivas PowerPoint se importan como Tablas de Rama con las respuestas Anterior y Siguente.</p> <p> <ol> <li>Abra su presentación PowerPoint.</li> <li>Guárdela como Página Web con codificación UTF8 (sin opciones especiales)</li> <li>El resultado del paso 3 debería ser un archivo HTML y una carpeta con todas las diapositivas convertidas a páginas web.<br /> COMPRIMA sólo LA CARPETA a un archivo ZIP de compresión normal.</li> <li>Vaya a su sitio Moodle y agrege una nueva lección.</li> <li>Tras haber guardado los ajustes de la lección, usted debería ver 4 opciones bajo &quot;¿Qué desea hacer primero?&quot; Haga clic en &quot;Importar PowerPoint&quot;</li> <li>Use el botón &quot;Navegar...&quot; para encontrar el archivo ZIP to find your zip hecho en el paso 3. Haga clic a continuación en &quot;Subir este archivo&quot;</li> <li>ISi todo ha ido bien, la próxima pantalla mostrará el botón Continuar.</li> </ol> </p> <p>Si la presentación en PowerPoint contenía imágenes, deberán haber sido guardadas como archivos del curso en moddata/XY donde X es el nombre de la lección e Y es un número (normalmente 0). Asimismo, durante el proceso de importación, se crearán archivos en el directorio de datos de Moodle, dentro de temp/lesson. Estos archivos por el momento no son eliminados por import.php.</p> <p align="center">&nbsp;</p>';
...
$string['maximumnumberofanswersbranches_help'] = '<p>Este valor determina máximo número de respuestas que usará el profesor. El valor por defecto es 4. Si una lección solo utilizará preguntas de VERDADERO o FALSO podemos asignarle el valor de 2.</p> <p>Este valor también se usa para asignar el máximo número de capítulos que se usarán en la lección.</p> <p>Puede editar, de forma segura, este valor en las lecciones ya creadas. De hecho, será necesario si desea añadir una pregunta con muchas opciones o ampliar el número de capítulos. Después de que haya añadido las preguntas o capítulos también puede reducir el valor a uno más &quot;estándar&quot;.</p>';
...
$string['mediafile'] = 'Archivo o página web en ventana emergente';
...
$string['modulename_help'] = 'El módulo lección le permite al profesor crear una experiencia de aprendijaje adaptiva, consistente en una serie de páginas con preguntas.';
