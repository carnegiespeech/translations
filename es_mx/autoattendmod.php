...
/**
 * Strings for component 'autoattendmod', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
...
$string['email_all'] = 'Mandar todos los reportes a profesores por Email';
$string['email_all_help'] = 'Si se habilita Email y Usted revisa esto, todos los reportes de días de asistencia son enviados por Email. Si Usted desactiva esto, solamente se envía un reporte de asistencia';
$string['email_all_title'] = 'Mandar todos los Reportes';
$string['email_enable'] = 'Habilitar notificación por Email';
$string['email_enable_help'] = 'Si Usted activa esto, cuando termine una sesión, los datos de asistencia se envían a profesores usando Email';
$string['email_enable_title'] = 'Notificación Email';
