...
/**
 * Strings for component 'enrol_ldap', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   enrol_ldap
...
$string['course_idnumber'] = 'Atributo LDAP del cual se obtiene el número ID (ID number) del curso. Usualmente  <em>cn</em> or <em>uid</em>. Se recomienda bloquear el valor si se está utilizando la creación automática del curso.';
