...
/**
 * Strings for component 'debug', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   debug
...
$string['noactivityname'] = 'El objeto página derivó de page_generic_activity pero no definió $this->activityname';
