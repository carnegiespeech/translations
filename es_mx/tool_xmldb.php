...
/**
 * Strings for component 'tool_xmldb', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   tool_xmldb
...
$string['binaryincorrectlength'] = 'Largo equivocado para el campo binario';
...
$string['mysqlextracheckbigints'] = 'Bajo MySQL, también busca bigints con signo incorrectos, generando el SQL necesario para ejecutarse para poder arreglarlos todos.';
...
$string['textincorrectlength'] = 'Largo incorrecto del campo de texto';
