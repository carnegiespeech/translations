...
/**
 * Strings for component 'editor_tinymce', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
...
$string['dragmath:dragmath_javaneeded'] = 'Para usar esta página Usted requiere un navegador que permita Java. Descargue el más reciente plugin para Java de {$a}.';
...
$string['media_dlg:flv_showscalemodes'] = 'Mostrar modos de escala';
...
$string['paste:plaintext_mode_sticky'] = '\'Pegar\' está ahora en modo de texto simple. Haga clic de nuevo para habilitar \'pegar\' en modo normal. Tras pegar algo, volverá al modo de pegado normal.';
