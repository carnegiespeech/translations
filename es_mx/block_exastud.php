...
/**
 * Strings for component 'block_exastud', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
...
$string['blockname'] = 'Revisión de Estudiante Exabis';
$string['blocktitle'] = 'Revisión de Estudiante Exabis';
...
$string['configteacher'] = 'Maestros en {$a}';
$string['configuration'] = 'Configuración de clase';
$string['detailedreview'] = 'Revisión detallada';
$string['editclasscategories'] = 'Editar categorías de evaluación';
$string['editclassmemberlist'] = 'Editar lista de estudiantes de clase';
$string['editclassname'] = 'Editar clase';
$string['editclassteacherlist'] = 'Editar lista de clase del maestro';
$string['endtime'] = 'horafinal:';
$string['errorinsertingcategories'] = 'Error al añadir categorías a un curso';
$string['errorinsertingclass'] = 'Error al insertar clase';
$string['errorinsertingperiod'] = 'Error al insertar período';
...
$string['errorinsertingteachers'] = 'Error al añadir maestro a un curso';
...
$string['errorremovingteachers'] = 'Error al remover maestro de un curso';
$string['errorstarttimebeforeendtime'] = '¡El período {$a->description} tiene su hora de inicio anterior a la hora de término!';
$string['errorupdateingperiod'] = 'Error al actualizar período';
...
$string['evaluation10'] = '10 - muy débil';
...
$string['exastud:head'] = 'Jefe de la clase';
...
$string['explainclassname'] = 'Elija aquí para editar el nombre de la clase';
...
$string['modulename'] = 'Revision de Estudiante Exabis';
$string['name'] = 'nombre';
...
$string['noperiods'] = 'Todavía no hay un período de evaluación definido. Por favor contacte al administrador, ¡quien le ayudará amablemente!';
