...
/**
 * Strings for component 'hub', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   hub
...
$string['moodleorgregistrationdetail'] = 'A la Central de Cursos (hub) principal se le conoce como MOOCH (MOodle.org Open Community Hub) y se encuentra en el sitio hub.moodle.org. Al registrar su sitio con MOOCH, contribuirá con las estadísticas de la comunidad internacional de usuarios de Moodle. También puede unirse a una lista de correo de bajo volumen de envíos desde la que se le proporcionarán notificaciones relevantes y revisiones de seguridad así como información relacionada con las nuevas versiones de Moodle.';
$string['moodleorgregistrationdetail2'] = 'Esta opción le permite registrar su sitio Moodle con MOOCH (Moodle.org Open Community Hub), en hub.moodle.org. El registro es gratuito. El principal beneficio de registrarse es que será añadido a una lista de correos de bajo volumen para las notificacione importantes como alertas de seguridad y nuevas versiones estables de Moodle. Por defecto, su información permanecerá privada, y nunca se venderá o pasará a nadie más. La única razón para recolectar información es para propósitos de soporte, y para ayudar a construir una imágen estadística de la comunidad Moodle como conjunto. Si lo elige, puede permitir que el nombre de su sitio, país y URL sean añadidos a la lista pública de sitios Moodle. Todos los nuevos registros son verificados manualmente antes de añadirse a la lista, pero una vez añadidos, Usted puede actualizar su registro (y su entrada en la lista pública) en cualquier momento.';
...
$string['registeronmoodleorg'] = 'Registrar con Moodle.org (MOOCH)';
$string['registeronspecifichub'] = 'Registrar con un hub específico';
...
$string['siteemail'] = 'Dirección Email';
