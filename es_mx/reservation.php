...
/**
 * Strings for component 'reservation', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   reservation
...
$string['eventevent'] = 'Crear un evento en fechas de inicio a fin (del evento)';
...
$string['reservationevent'] = 'Crear un evento con fechas desde apertura a cierre (hora de reservación)';
...
$string['upload_help'] = '<p>Las reservaciones pueden subirse mediante archivo de texto. El formato del archivo debería de ser como sigue:</p><ul><li>Cada línea del archivo contiene un registro</li><li>Cada registro es una serie de datos separados por comas (o algun otro delimitador)</li><li>El primer registro contiene una lista de nombres_de_campos (\'\' fieldnames \'\') que definen el formato del resto del archivo</li><li>Los nombres_de_campos (\'\' fieldsname \'\') requeridos son section, name y timestart</li><li>Los nombres_de_campo ( \'\' fieldsname \'\') opcionales son course, intro, teachers, timeend, maxgrade, timeopen, timeclose, maxrequest</li><li>Si course no está especificado, deberá de elegirse después de la vista previa</li></ul>';
