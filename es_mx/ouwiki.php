...
/**
 * Strings for component 'ouwiki', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   ouwiki
...
$string['advice_annotate'] = '<p>Hacer anotaciones en la página inferior.</p> <ul> <li>Para hacer anotaciones elija uno de los marcadores de anotaciones y escriba el texto necesario.</li> <li>Las anotaciones nuevas y existentes pueden borrarse quitando  todo el texto en el formato inferior.</li> </ul>';
...
$string['annotation_help'] = '<p>Un usuario, con el permiso apropiado, can add inline annotations to the wiki.</p>';
