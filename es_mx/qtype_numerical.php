...
/**
 * Strings for component 'qtype_numerical', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
...
$string['addmoreanswerblanks'] = 'Espacios vacíos para {no} opciones más';
...
$string['unitnotselected'] = 'Usted debe seleccionar una unidad';
...
$string['validnumberformats_help'] = '* números regulares 13500.67, 13 500.67, 13500,67 o 13 500,67 * si usa el Español de México y la configuración de su paquete de idioma (langconfig.php) emplea la coma (,) como separador de miles *siempre* ponga el punto decimal (.) como en 13,500.67 : 13,500. * para formato exponente, digamos 1.350067 * 10<sup>4</sup>, use 1.350067 E4 : 1.350067 E04';
