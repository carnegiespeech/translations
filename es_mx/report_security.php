...
/**
 * Strings for component 'report_security', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
...
$string['check_passwordsaltmain_details'] = '<p>Configurar una sal de contraseña reduce grandemente el riesgo de robo de contraseña.</p> <p>Para configurar una sal de contraseña añada la siguiente línea a su archivo config.php file:</p> <code>$CFG->passwordsaltmain = \'una cadena larga aleatoria de muchos caracteres\';</code> <p>La cadena aleatoria de caracteres debería ser una mezcla de letras, números y caracteres no alfanuméricos. Se recomienda una longitud de 40 caracteres.</p> <p>Por favor diríjase a  <a href="{$a}" target="_blank">password salting documentation</a> Si deseara cambiar la sal de contraseña, una vez que la ponga, ¡NO DEBE BORRAR LA SAL, porque no podría volver a ingresar a su sitio!</p>';
