...
/**
 * Strings for component 'enrol_lmb', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   enrol_lmb
...
$string['disablesecurity'] = 'Deshabilitar seguridad';
...
$string['ignoreusernamecase'] = 'Ignorar MAYÚSCULAS del nombre_de_usuario';
$string['ignoreusernamecasehelp'] = 'Todos los nombres_de_usuarios serán convertidas a minúsculas cuando se seleccione esta opción.';
...
$string['lmbpasswdhelp'] = 'Esta es la contraseña usada para limitar el acceso a la interfaz de LMB. Debe de coincidir con las configuraciones en Luminis Message Broker.';
...
$string['lmbusername'] = 'Nombre_de_usuario';
...
<li>useridtype - Login ID: Use el valor proporcionado por el campo de contraseña de la marca (tag) userid que está marcada como (ID para ingresar) \'Login ID\'.
<li>useridtype - SCTID: Use el valor proporcionado por el campo de contraseña de la marca (tag) userid que está marcada como \'SCTID\'.
<li>useridtype - Email ID: Use el valor proporcionado por el campo de contraseña de la marca (tag) userid que está marcada como (ID del Email) \'Email ID\'.
<li>useridtype - Otro: Use el valor proporcionado por el campo de contraseña de la marca (tag) userid que está marcada como se indica en la caja de texto.
</ul>';
...
<li>useridtype - Login ID: Use el valor proporcionado en la marca (tag) del userid que está marcada como  \'Login ID\'.
<li>useridtype - SCTID: Use el valor proporcionado en la marca (tag) del userid que está marcada como   \'SCTID\'.
<li>useridtype - Email ID: Use el valor proporcionado en la marca (tag) del userid que está marcada como   \'Email ID\'.
<li>useridtype - Otro:  Use el valor proporcionado en la marca (tag) del userid que está marcada como  está indicado en la caja de texto.
</ul>';
