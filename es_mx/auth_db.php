...
/**
 * Strings for component 'auth_db', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   auth_db
...
$string['auth_dbfielduser'] = 'Nombre del campo que contiene los nombres_de_usuarios';
...
$string['auth_dbtype'] = 'El tipo de base de datos (Vea la <a href="http://phplens.com/adodb/supported.databases.html" target="_blank">ADOdb documentation</a> para obtener más detalles)';
