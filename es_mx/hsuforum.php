...
/**
 * Strings for component 'hsuforum', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   hsuforum
...
$string['addanewdiscussion'] = 'Añadir un nuevo tema/tópico de discusión';
$string['addanewquestion'] = 'Añadir una nueva pregunta';
$string['addanewtopic'] = 'Añadir un nuevo tema/tópico';
...
$string['anonymous'] = 'Permitir publicación anónima';
$string['anonymousfirstname'] = 'Anónima';
$string['anonymous_help'] = 'Si se habilita, entonces el nombre del autor  para cada publicación será suprimido al ver el foro.';
...
$string['cannotcreateinstanceforteacher'] = 'No se pudo crear la nueva instancia del curso para el foro del maestro';
...
$string['configenabletimedposts'] = 'Selecione "Si" si quiere permitir la visualización de periodos de tiempo al publicar en un nuevo foro de discusión (Experimental porque no ha sido probado completamente)';
...
$string['displayend_help'] = 'Esta configuración especifica si es que una publicación en foro debería de ocultarse después de una cierta fecha. Tome nota de que los administradores siempre podrán ver las publicaciones en foros.';
...
$string['hsuforum:addnews'] = 'Añadir novedades';
...
$string['hsuforum:managesubscriptions'] = 'Gestionar suscripciones';
...
$string['hsuforum:replynews'] = 'Contestar a las novedades';
...
$string['modulename'] = 'Foro Avanzado';
$string['modulename_help'] = 'El módulo de foro les permite a los participantes tener discusiones asincrónicas.';
$string['modulenameplural'] = 'Foros Avanzados';
$string['more'] = 'más';
$string['movedmarker'] = '(Movido)';
$string['movethisdiscussionto'] = 'Mover esta discusión a ...';
$string['namenews'] = 'Foro de Novedades';
$string['namenews_help'] = 'El foro de Novedades es un foro especial para anuncios que es creado automáticamente cuando se crea un curso. Un curso solamente puede tener un solo foro de Novedades. Solamente los profesores y administradores pueden publicar en elforo de Novedades. El bloque de Últimas noticias" mostrará discusiones recientes del foro de Novedades.';
...
$string['pluginname'] = 'Foro Avanzado';
