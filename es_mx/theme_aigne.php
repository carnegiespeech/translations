...
/**
 * Strings for component 'theme_aigne', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   theme_aigne
...
$string['accessibilitydesc'] = 'Si activa esta opción, aparecerá un enlace en el pie de página a la información sobre accesibilidad de la plataforma';
...
Tome nota de que algunos enlaces no tienen espaciamiento de letra por defecto.';
...
$string['banner1alt'] = 'Escriba aquí el título del banner';
...
$string['bcsepdesc'] = 'Seleccione el tipo de separador a usar en la Barra de Navegación (ruta de navegación)';
...
$string['breadcrumbhead'] = 'Opciones de Barra de navegación (breadcrumb)';
...
$string['creditshead'] = 'Publicaciones de créditos';
...
$string['custommtag'] = 'Meta Marcas (Tags) Personalizadas';
...
$string['datemessage'] = 'Mensaje de Bienvenida';
...
$string['disclaimerdesc'] = 'Si se habilita, muestra un enlace en el pie de página hacia una advertencia legal obligatoria (por ejemplo: La información aquí presentada es responsabilidad exclusiva de los fulanos que la escribieron y la institucion ABCDEFG no se hace responsable por nada malo que pudiera pasarle a alguien si les hace caso...)';
...
$string['footsearchdesc'] = 'Si activa esta opción, aparecerá un enlace en el pie de página a la búsqueda general dentro de la plataforma';
...
$string['help'] = 'ayuda';
$string['helpdesc'] = 'Si activa esta opción, aparecerá un enlace en el pie de página a la ayuda general de la plataforma';
...
$string['mtaghead'] = 'Opciones de Meta Marcas (Tags)';
...
$string['mtdescription'] = 'Meta Marca (Tag) de Descripción';
...
$string['policiesdesc'] = 'Si activa esta opción, aparecerá un enlace en el pie de página a las política generales de la plataforma';
...
$string['privacydesc'] = 'Si activa esta opción, aparecerá un enlace en el pie de página a la información sobre la privacidad en la navegación dentro de la plataforma';
...
<h2>Parámetros que se pasan:</h2>
  ...
  <ul>{$a->referer}</ul>
  <p>&nbsp;</p>';
$string['quadro1alt'] = 'Escriba aquí el título del cuadro 1';
...
$string['quadro2alt'] = 'Escriba aquí el título del cuadro 2';
...
<strong>Puede darle el formato CSS que quiera en el archivo aigne_style.css</strong>';
$string['quadro3alt'] = 'Escriba aquí el título del cuadro 3';
...
$string['securitydesc'] = 'Si activa esta opción, aparecerá un enlace en el pie de página a la información sobre la seguridad en la navegación dentro de la plataforma';
...
$string['statsdesc'] = 'Si activa esta opción, aparecerá un enlace en el pie de página a las estadísticas de uso de la plataforma';
...
$string['usernavsalutdesc'] = 'Si activa esta opción, aparecerá el saludo que escriba en el siguiente recuadro.<br />
Si deja en blanco el siguiente recuadro, se mostrará un saludo condicional según la hora del día.';
...
$string['webmapdesc'] = 'Si activa esta opción, aparecerá un enlace en el pie de página al Esquema de páginas de la plataforma, que formará el Mapa Web';
