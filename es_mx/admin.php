...
/**
 * Strings for component 'admin', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   admin
...
$string['allowuserthemes'] = 'Permitirle temas al usuario';
...
$string['condifmodeditdefaults'] = 'Los valores que fije aquí definen los valores por defecto que se usan en el formato de ajustes de la actividad cuando usted crea una actividad nueva. Puede asimismo configurar qué ajustes de la actividad considera como avanzados.';
...
$string['configcachetype'] = 'Seleccione un tipo de caché para Moodle. Esto únicamente configurará el caché; recuerde activar rcache de manera que el caché pueda ser usado para algo. Úselo <strong>únicamente</strong> si necesita reducir la carga en el sistema de base de datos -- de lo contrario Moodle se ejecutará realmente más lento. Sitios con tráfico mediano pueden beneficiarse usando \'internal\' (interno). Un solo servidor web con eAccelerator o Turckmmcache instalados <em>con las opciones de memoria compartida activadas</em> debería probar \'eaccelerator \'. Si tiene una configuración multiservidor, y tiene uno o más servicios en la memoria memcached ejecutándose y la extensión PHP-memcached, seleccione \'memcached\' y configure las opciones de la memoria memcached debajo.<br /><strong>Nota:</strong> asegúrese de probar el rendimiento en carga y ajuste -- Los cachés pueden hacer su sitio más lento. En situaciones de alto tráfico, eAccelerator y la memoria memcached pueden ser los más benéficos, pero pueden tener un alto costo en el uso del CPU del servidor web.';
...
$string['configdefaultallowedmodules'] = 'Para los cursos que caen en la categoría de arriba, ¿cuales módulos quiere permitir por defecto <b>cuando el curso es creado</b>?';
...
Tome nota de que si deja vacío este espacio, desaparecerá el enlace hacia \'Moodle Docs para esta página\' que usualmente está al fondo de la página.';
...
$string['configgooglemapkey'] = 'Necesita introducir una clave especial para utilizar Google Maps para visualizar la búsqueda de la dirección IP. Puede obtener dicha clave gratuitamente en <a href="https://developers.google.com/maps/documentation/javascript/v2/introduction#Obtaining_Key">https://developers.google.com/maps/documentation/javascript/v2/introduction#Obtaining_Key</a>.<br />La URL de su sitio web es: {$a}';
...
$string['configmemcachedhosts'] = 'Para la memoria memcached. Lista de \'hosts\' separados por coma que ejecutan el \'daemon\' memcached. Utilice direcciones IP para evitar latencia DNS. La memoria memcached no se comporta bien si añade o quita \'hosts\' en una instalación corriendo.';
...
$string['confignavshowallcourses'] = 'Si se habilita, los usuarios verán cursos a los que están inscritos, tanto en la rama de  Mis Cursos y en la estructura del curso. Cuando se deshabilita los usuarios con inscripción solamente verán la rama de Mis Cursos de la navegación. El número de cursos mostrados todavía estaría limitado por la configuración de  "Course limit(navcourselimit)"  cuando el usuario estuviera fuera-del-sistema o no-inscrito en ningún curso.';
...
$string['configrcachettl'] = 'Tiempo de permanencia (en segundos) de los registros en la caché. Utilice un valor bajo aquí (<15).';
...
$string['configrestrictbydefault'] = '¿Deberían de tener sus módulos restringidos por defecto los cursos nuevos creados que caen en la categoría de arriba?';
$string['configrestrictmodulesfor'] = '¿Cuales cursos deberían de tener por defecto <b>la opción de configuración</b> para deshabilitarles algunos módulos de actividades? Observe que esta configuración solamente aplica para profesores, porque los administradores aún podrán añadir cualquier actividad a cualquier curso.';
...
$string['configuseexternalyui'] = 'En lugar de usar archivos locales, usar archivos disponibles en línea en servidores Yahoo‘s. ADVERTENCIA: Esto requiere una conexión de internet; de otro modo, AJAX no funcionará en el sitio. Esta configuración no es compatible con sitios que usen https.';
...
$string['configusetags'] = '¿Habilitar la funcionalidad de marcas (tags) para todo el sitio? (por ejemplo: intereses en perfil de usuario). Esto puede ser muy útil para promover socialización, o muy peligroso si tiene usuarios muy traviesos o irreverentes...';
...
$string['courselistshortnames_desc'] = 'Al mostrar la lista de cursos, o al referirse a los cursos en pantallas de administración, mostrar el nombre corto del curso y el nombre completo también. De hecho, cuando Usted activa esta configuración, la vista emplea  la cadena de idioma \'courseextendednamedisplay\' , para que Usted pueda cambiar lo que se muestra mediante la configuración a la medida del idioma.';
...
$string['enablecourseajax'] = 'Permitir editar curso con AJAX';
$string['enablecourseajax_desc'] = 'Permitir AJAX al editar las páginas principales del curso. Observe que el formato y el tema del curso deben soportar la edición con AJAX y el usuario requiere habilitar AJAX en su perfil, también.';
...
$string['frontpageitem'] = 'Item de portada {$a}';
$string['frontpageitemloggedin'] = 'Item de portada {$a} al estar identificado';
...
$string['googlemapkey'] = 'Clave de Google Maps API V2';
...
$string['helpforcetimezone'] = 'Puede permitir que los usuarios seleccionen su zona horaria, o forzarla para todos (por ejemplo: América/México_DF).';
...
$string['invaliduserchangeme'] = 'El nombre_de_usuario" changeme" es reservado: no puede crear una cuenta con ese nombre.';
...
$string['iplookupnetgeonote'] = 'Actualmente se emplea el servidor NetGeo para buscar información geográfica. Para resultados más exactos nosotros recomendamos instalar una copia local de la base de datos MaxMind GeoLite.';
...
$string['navlinkcoursesections'] = 'Ligar secciones de curso';
$string['navlinkcoursesections_help'] = 'Si se habilita, las secciones del curso se mostrarán como ligas en la navegación.';
...
$string['numcoursesincombo'] = 'Número máximo de cursos en lista combo';
$string['numcoursesincombo_help'] = 'La lista combo no funciona bien con un número grande de cursos. Cuando el número total de cursos en este sitio sea mayor a este valor, entonces de mostrará un enlace a la lista dedicada de cursos en lugar de tratar de mostrar todos los cursos en la portada.';
...
$string['profilingautofrec_help'] = 'Al configurar esta característica, una solicitud (aleatoria, basada en la frecuencia especificada -1 de XXX) será elegida y perfilada automáticamente, guardando los resultados para análisis posterior. Observe que esta forma de perfilar observa la configuración de incluir/excluir. Si la pone a 0 se desactiva el perfilado automático.';
...
Por favor si está en México le recomendamos que consulte la página y siga las indicaciones del <a href="http://www.ifai.gob.mx">Instituto Federal de Acceso a la Información y Protección de Datos</a>';
$string['simpletest'] = 'Pruebas de Unidad';
