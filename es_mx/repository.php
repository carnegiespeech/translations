...
/**
 * Strings for component 'repository', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   repository
...
$string['confirmremove'] = '¿Está seguro de que desea eliminar este plugin de repositorio, sus opciones y <strong>todas sus instancias</strong> - {$a}?';
