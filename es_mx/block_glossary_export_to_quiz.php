...
/**
 * Strings for component 'block_glossary_export_to_quiz', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
...
$string['notenoughentries'] = 'No hay suficientes entradas (<b>{$a->numentries}</b>) en <b>Glosario</b> <em>{$a->varnotenough}</em> para preguntas de opción múltiple.';
