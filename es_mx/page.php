...
/**
 * Strings for component 'page', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   page
...
$string['modulename_help'] = 'Una página le permite al profesor mostrar y editar una página web empleando el editor de texto.';
