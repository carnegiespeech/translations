...
/**
 * Strings for component 'scorm', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   scorm
...
$string['displayattemptstatusdesc'] = 'Esta preferencia fija el valor por defecto para mostrar el ajuste de status de intentos';
...
$string['forcecompleted_help'] = 'Si se activa, el status del intento actual se cambia a "Finalizado". Este ajuste sólo se aplica a los paquetes SCORM 1.2. Es útil si el paquete SCORM no se ocupa de revisar el intento correctamente, ya sea en la revisión o en el modo de exploración, o se produce cualquier otro funcionamiento incorrecto en el estado de "Finalización"';
...
$string['missingparam'] = 'Un elemento requerido falta o está equivocado';
...
$string['onchanges'] = 'Cada vez que cambie';
...
$string['optionsadv_desc'] = 'Si se selecciona, la ventana de opciones se establece como opciones avanzadas en el formato.';
...
$string['time'] = 'Hora';
$string['timerestrict'] = 'Restringir la respuesta a este período de tiempo';
$string['title'] = 'Título';
...
La opción del último intento completado no incluye los intentos con status de \'fallido\' o \'reprobado\'
