...
/**
 * Strings for component 'forum', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   forum
...
<P><B>Cada persona plantea un tema a discusión.</B> Cada persona puede plantear exactamente un nuevo tema de discusión (y todos pueden responder). Esta modalidad es útil cuando usted quiere que cada estudiante empiece una discusión sobre, digamos, sus reflexiones sobre el tema de la semana, y que todos los demás le puedan responder.

<P><B>Una discusión única sencilla.</B> Es simplemente un intercambio de ideas sobre un solo tema, todo en una página. Útil para debates cortos y concretos. Todos pueden responder al tema de discusión.

<P><B>Foro de Preguntas y Respuestas.</B> Los estudiantes primero deben escribir sus puntos de vista antes de ver los mensajes de los demás.
...
<P><B>Foro para uso general.</B> Es un foro abierto donde cualquiera puede empezar un nuevo tema de discusión en cualquier momento. Este es el foro más adecuado, para uso general.';
...
$string['modulename_help'] = 'El módulo foro les permite a los participantes tener discusiones asincrónicas (en diferentes tiempos).';
...
$string['nowsubscribed'] = '{$a->name} será notificado sobre nuevas publicaciones en \'{$a->forum}\' por correo.';
...
$string['overviewnumunread'] = 'total de {a$} no leídos';
