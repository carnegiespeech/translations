...
/**
 * Strings for component 'access', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   access
...
$string['breadcrumb'] = 'Camino de la ruta de navegación (breadcrumb)';
...
$string['tablelayout'] = 'Tabla de diseño, {$a}';
