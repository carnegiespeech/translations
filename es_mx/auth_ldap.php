...
/**
 * Strings for component 'auth_ldap', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   auth_ldap
...
$string['updatepasserrorexpire'] = 'Error en user_update_password{} al leer el período de expiración de la contraseña.  Código de error: {$a->errno}. Cadena del error: {$a->errstring}';
$string['updatepasserrorexpiregrace'] = 'Error en user_update_password{} al modificar el período de caducidad y/o los ingresos libres.  Código de error: {$a->errno}. Cadena de texto del error: {$a->errstring}';
