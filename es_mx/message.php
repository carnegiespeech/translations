...
/**
 * Strings for component 'message', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   message
...
$string['couldnotfindpreference'] = 'No se pudieron cargar las preferencias {$a}. ¿El componente y nombre que proporcionó a message_send() coincide con una fila en message_providers? Los proveedores de mensajes deben aparecer en la base de datos para que los usuarios puedan configurar cómo serán notificados cuando reciban mensajes.';
