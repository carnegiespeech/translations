...
/**
 * Strings for component 'tool_langimport', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
...
$string['remotelangnotavailable'] = 'Debido a que Moodle no puede conectarse a download.moodle.org, no podemos instalar el paquete de idioma automáticamente. Por favor, descargue los archivos ZIP apropiados de http://download.moodle.org, cópielos a su directorio {$a} y descomprímalos manualmente.';
$string['uninstall'] = 'Desinstalar paquete de idioma seleccionado';
