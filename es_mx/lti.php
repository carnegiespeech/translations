...
/**
 * Strings for component 'lti', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   lti
...
$string['id'] = 'id';
$string['imsroleadmin'] = 'Insstructor, Administrador';
$string['imsroleinstructor'] = 'Instructor';
$string['imsrolelearner'] = 'Alumno';
...
* **Por defecto** - Usa el contenedor especificado por la configuración de la herramienta.
...
$string['lti'] = 'LTI';
$string['lti:addcoursetool'] = 'Calificar actividades LTI (Learning Tools Interoperability = Interoperatividad de Herramientas de Aprendizaje)';
...
$string['lti:grade'] = 'Calificar actividades LTI (Learning Tools Interoperability = Interoperatividad de Herramientas de Aprendizaje)';
...
$string['lti:manage'] = 'Editar actividades LTI (Learning Tools Interoperability = Interoperatividad de Herramientas de Aprendizaje)';
$string['lti:requesttooladd'] = 'Mandarle una herramienta a los Administradores para que la configuren';
...
$string['lti:view'] = 'Ver actividades LTI (Learning Tools Interoperability = Interoperatividad de Herramientas de Aprendizaje)';
...
$string['modulename_help'] = 'Las herramientas externas les permiten a los usuarios de Moodle interactuar con recursos educativos y actividades alojadas en otros sitios de internet. Por ejemplo, una herramienta externa podría proporcionar acceso a un nuevo tipo de actividad o de materiales educativos de una editorial. Para configurar una instancia de una herramienta externa se requiere un provedor de herramienta que soporte  LTI (Learning Tools Interoperability = Interoperatividad de Herramientas de Aprendizaje). Si Usted encuentra un provedor de herramienta que soporta LTI, ellos deberían de poder proporcionarle a Usted las instrucciones para configurar la instancia de herramienta externa. Adicionalmente, los tipos de herramientas configurados por un Administrador del sitio también estarán disponibles para su empleo. Las herramientas externas difieren se los recursos URL en varias formas: * **Conscientes del Contexto** - Las herramientas externas tienen acceso a información sobre el usuario que invocó la herramienta, como por ejemplo la institución, curso, nombre y otra información. * **Integración profunda** - Las herramientas externas soportan leer, actualizar y borrar calificaciones asociadas con la instancia de la actividad. Para futuras versiones de Moodle se planean más puntos de integración. * **Seguridad** - Las configuraciones de la herramienta externa crean una relación de confianza entre Moodle y el provedor de la herramienta, permitiendo la comunicción segura entre ambos.';
...
$string['send'] = 'Enviar';
$string['setdefault'] = 'Configure un valor por defecto para el profesor si está delegando';
$string['setupbox'] = 'Caja de Configuración de Herramienta LTI';
...
$string['toolurl_help'] = 'La URL Base de la Herramienta se emplea para aparear las URLs para invocar herramientas con las configuraciones de Herramientas correcspondientes. Ponerle el prefijo http(s) a la URL es opcional. Adicionalmente, la URL base se emplea como URL para invocar si es que no se especificó una URL en la instancia de la herramienta externa. <table> <thead> <tr> <td> <b>URL Base</b> </td> <td> <b>Coincide</b> </td> </tr> </thead> <tbody> <tr> <td> tool.com </td> <td> tool.com, tool.com/quizzes, tool.com/quizzes/quiz.php?id=10, www.tool.com/quizzes </td> </tr> <tr> <td> www.tool.com/quizzes </td> <td> tool.com/quizzes, tool.com/quizzes/take.php?id=10, www.tool.com/quizzes </td> </tr> <tr> <td> quiz.tool.com </td> <td> quiz.tool.com, quiz.tool.com/take.php?id=10 </td> </tr> </tbody> </table> Si dos diferentes configuraciones de herramienta son para un mismo dominio, la que concuerde más especificamente será la que se utilice.';
