...
/**
 * Strings for component 'enrol_attributes', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
...
$string['defaultrole'] = 'Rolp por defecto';
$string['defaultrole_desc'] = 'Rol por defecto usado para inscribir personas con este plugin (cada instancia puede anular esto).';
$string['force'] = 'Forzar inscripciones';
$string['mappings'] = 'Mapeos';
$string['mappings_desc'] = 'Lista de valores (uno por línea), por ejemplo : <br /><code>Shib-SwissEP-HomeOrganizationType:homeorganizationtype</code>';
