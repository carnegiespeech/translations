...
/**
 * Strings for component 'auth_cas', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   auth_cas
...
$string['auth_cas_multiauth'] = 'Seleccione \'sí\' si quiere tener multi-autenticación (CAS + otra autenticación)';
