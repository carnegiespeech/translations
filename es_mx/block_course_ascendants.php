...
/**
 * Strings for component 'block_course_ascendants', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
...
$string['open'] = 'Abierto';
$string['openclosemodules_help'] = '## Acceso  a ascendentes de curso

### Abriendo, cerrando cursos paternos

Los cursos paternos son metacursos que heredan inscripciones de este curso.

Al abrir (asignar ) un ascendente, Usted enlazará este curso al metacurso específico, y de esta manera inscribirá a los usuarios actuales y les dará acceso al contenido del metacurso.

Al cerrar un módulo (desasignar), Usted desligará a las inscripciones. Sus estudiantes ya no serán capaces de entrar al curso, pero su producción (documentos y datos) permanecerá guardada dentro de los datos del curso. Si Usted volviera a abrir el acceso al módulo, sus usuarios recuperarán el curso en el mismo estado en que lo dejaron.';
