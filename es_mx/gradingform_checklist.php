...
/**
 * Strings for component 'gradingform_checklist', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
...
$string['checkitem'] = 'Revisar este ítem';
...
$string['itemremark'] = 'Comentario al ítem';
...
$string['regrademessage1'] = 'Usted está a punto de guardar cambios a una lista de verificación (checklist) que ya ha sido usada para calificar.. Por favor, indique si las calificaciones existentes necesitan ser revisadas. Si Usted configura así esto, entonces la lista de verificación (checklist) estará oculta para los estudiantes hasta que su ítem sea re-calificado.';
$string['regrademessage5'] = 'Usted está a punto de guardar cambios significativos a una lista de verificación (checklist) que ya ha sido usada para calificar. El valor del Libro de Calificaciones no se cambiará, pero la lista de verificación estará oculta para los estudiantes hasta que su ítem sea re-calificado.';
$string['regradeoption0'] = 'No marcar para re-calificar';
$string['regradeoption1'] = 'Marcar para re-calificar';
$string['restoredfromdraft'] = 'NOTA: El último intento para calificar a esta persona no fue guardado apropiadamente, por lo que se han restaurado las calificaciones del borrador. Si Usted quiere cancelar estos cambios, use el botón inferior para \'Cancelar\'.';
$string['save'] = 'Guardar';
