...
/**
 * Strings for component 'quiz_statistics', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
...
$string['erroritemappearsmorethanoncewithdifferentweight'] = 'La pregunta ({$a}) aparece más de una vez en el examen con diferentes puntajes de calificación. Actualmente esto no está soportado en el reporte de estadísticas y puede hacer que las estadísticas para esta pregunta no sean fiables.';
