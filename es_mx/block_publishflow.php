...
/**
 * Strings for component 'block_publishflow', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
...
$string['synchplatforms'] = '<p>Si recientemente se ha añadido un nuevo host de Moodle a su red, Usted puede re-sincronizar la definicón de los campos de usuario de acceso empleando este script.</p><p>En una red de publicación, el acceso a los hosts en la red está controlado por campos personalizados dedicados de perfil de usuario.</p>';
