...
/**
 * Strings for component 'auth', language 'es_mx', branch 'MOODLE_22_STABLE'
 *
 * @package   auth
...
$string['auth_updatelocal_expl'] = '<p><b>Actualizar datos locales:</b> Si está activado, el campo debe ser actualizado (con autorización externa) cada vez que el usuario ingresa o se produce una sincronización de usuarios. Los campos configurados para  actualizarse localmente deberían estar bloqueados.</p>';
...
$string['changepasswordhelp'] = 'Aquí puede especificar dónde pueden sus usuarios recuperar o cambiar su nombre_de_usuario /contraseña si lo han olvidado. Para ello, aparecerá un botón en la página de ingreso. Si deja esto en blanco, este botón no se mostrará.';
