...
$string['accesstofunctionnotallowed'] = '对函数 {$a}() 的访问被拒绝。请检查包含该函数的服务是否开启。在服务选项中：如果该服务是受限的，检查该用户是否被允许。还是在服务选项中，检查IP限制，或者该服务是否需要某权限。';
...
$string['enabled'] = '启用';
$string['enabledirectdownload'] = '必须在外部服务设置中启用Web服务文件下载';
...
$string['print'] = '全部打印';
$string['protocol'] = '协议';
$string['protocolnotallowed'] = '您不能使用 {$a} 协议（缺少权限：webservice/{$a}:use）';
