...
$string['configgooglemapkey'] = '为了使用 Google Maps 可视化查看 IP 地址分布，您需要输入一个专用的Key。可以通过<a href="https://developers.google.com/maps/documentation/javascript/v2/introduction#Obtaining_Key">https://developers.google.com/maps/documentation/javascript/v2/introduction#Obtaining_Key</a>免费获取。<br />您网站的地址是： {$a}';
...
$string['frontpageitem'] = '首页项{$a}';
$string['frontpageitemloggedin'] = '登录后首页项目{$a}';
...
$string['googlemapkey'] = 'Google 地图的 API V2 密钥';
