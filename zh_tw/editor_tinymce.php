...
/**
 * Strings for component 'editor_tinymce', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
...
$string['advanced_dlg:charmap_usage'] = '使用左、右箭頭來導覽';
...
$string['advlist:disc'] = '磁碟';
$string['advlist:lower_alpha'] = '小寫的字母';
$string['advlist:lower_greek'] = '小寫的希臘字';
$string['advlist:lower_roman'] = '小寫的羅馬字';
$string['advlist:square'] = '方格';
$string['advlist:types'] = '類型';
$string['advlist:upper_alpha'] = '大寫的的字母';
$string['advlist:upper_roman'] = '大寫的羅馬字';
$string['autosave:restore_content'] = '恢復自動保存的內容。';
$string['autosave:unload_msg'] = '如果离开此页面将导致所做的更改全部遗失。';
$string['autosave:warning_message'] = '如果恢復保存的內容，你將失去所有的內容，這是目前在編輯器中。你確定你要恢復保存的內容？';
$string['common:apply'] = '应用';
$string['common:browse'] = '浏览';
$string['common:browseimage'] = '尋找或上傳一圖像...';
$string['common:browsemedia'] = '尋找或上傳一個聲音、影片或小應用程式...';
...
$string['dragmath:dragmath_desc'] = '插入數學公式';
$string['dragmath:dragmath_javaneeded'] = '要使用這個頁面，你需要一個支持Java的瀏覽器。

你可從{$a}下載最新的Java插件。';
$string['dragmath:dragmath_title'] = '數學公式編輯器';
...
$string['moodlenolink:desc'] = '防止自動鏈結';
...
$string['paste:plaintext_mode'] = '黏貼現在是處於純文字模式，再點選一次，可以切換回一般黏貼模式';
$string['paste:plaintext_mode_sticky'] = '黏貼現在是處於純文字模式，再點選一次，可以切換回一般黏貼模式。在你貼上東西之後，你應該返回一般黏貼模式。';
