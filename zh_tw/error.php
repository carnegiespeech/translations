...
/**
 * Strings for component 'error', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
 * @package   error
...
$string['cannotnetgeo'] = '無法連結到http://www.geoplugin.com 的 geoPlugin 伺服器，請檢查代理伺服器設定或最好安裝 MaxMind GeoLite City 資料庫文件';
...
$string['csvloaderror'] = '當裝載CSV檔案時發生錯誤!';
...
$string['invalidgradeitmeid'] = '無效的成績項目ID';
...
$string['wrongcontextid'] = '脈絡的編號錯誤（無法找到該編號）';
