...
/**
 * Strings for component 'group', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
 * @package   group
...
$string['groupmembersonly_help'] = '若這方格被勾選，這活動(或資源)將只能用於被選出的分群中的分組成員。';
...
　　      <li>分隔小組 - 每個組的成員都只能看到自己的組員，不能看到其他的小組；</li>
　　      <li>可視小組 - 每個組的成員都自己完成工作，但可以看到其他小組的情況。</li>
　　   </ul>
　
<p>分組模式可以在兩個層次上定義：</p>
<dl>
