...
/**
 * Strings for component 'data', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
 * @package   data
...
$string['errorpresetexists'] = '這選出名字已經有一預設';
...
$string['portfolionotfile'] = '匯出到作品選集，而不是一個檔案(只限 CSV 和 leap2a)';
