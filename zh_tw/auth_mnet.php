...
/**
 * Strings for component 'auth_mnet', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
 * @package   auth_mnet
...
<ul><li><em>相依性</em>: 你也必須<strong>允諾</strong>在{$a}的SSO (服務提供者) 服務..</li></ul><br />Subscribe to this service to allow authenticated users from {$a} to access your site without having to re-login. <ul><li><em>Dependency</em>: You must also <strong>publish</strong> the SSO (Service Provider) service to {$a}.</li></ul><br />';
