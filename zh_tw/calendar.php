...
/**
 * Strings for component 'calendar', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
 * @package   calendar
...
$string['calendarpreferences'] = '行事曆喜好設定';
...
$string['invalidtimedurationuntil'] = '您為"持續直到"選擇的時間和日期早於世間的開始時間。請在繼續處裡前，修正這個問題。';
...
$string['pref_lookahead_help'] = '這了設定未來多少天內會發生的事件被顯示為即將發生的事件。此天數以後發生的事件不會被顯示為即將發生。請注意，<strong>不保證</strong>在此時間視窗內開始的事件會被顯示；如果有太多(超過"最多顯示幾件即將來臨的事件"設定)，那麼離最遠的事件不會被顯示';
...
$string['pref_startwday_help'] = '行事曆的星期將從您選擇的那天開始';
$string['pref_timeformat'] = '時間顯示格式';
$string['pref_timeformat_help'] = '您可以選擇使用12小時或24小時格式。如果您選擇"預設"，系統將根據您所使用的語言自動為您選擇時間格是。';
