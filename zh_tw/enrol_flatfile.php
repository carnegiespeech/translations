...
/**
 * Strings for component 'enrol_flatfile', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
...
$string['mailstudents'] = '透過Email提醒學生';
$string['mailteachers'] = '透過Email提醒老師';
$string['mapping'] = '一般檔案對應';
$string['messageprovider:flatfile_enrolment'] = '一般檔案對應選課資訊';
$string['pluginname'] = '一般檔案(CSV)';
$string['pluginname_desc'] = '該方法會反覆在您指定的位置檢查和處理一個特殊格式的文字檔案。此檔案每行應有四個或六個用逗號分隔的字段：

<pre class="informationbox">
*  operation, role, idnumber(用戶), idnumber(課程) [, starttime, endtime]
其中：
*  operation     = add | del
*  role          = student | teacher | teacheredit
*  idnumber(用戶)   = 用戶資料表中的學號（不是id）
