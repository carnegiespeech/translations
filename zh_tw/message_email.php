...
/**
 * Strings for component 'message_email', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
...
$string['configsmtphosts'] = '填入一個或多個本地SMTP伺服主機全名(例如「mail.a.com」或「mail.a.com; mail.b.com」)，Moodle系統將用它(們)發送郵件。

要指派一個非預設的埠(埠25以外的)，你可以使用[server]:[port] 語法，(例如，mail.a.com:578)。

為了安全，埠456通常用於SSL，埠578通常用於TLS，若需要時指定安全傳輸協定。

如果你留空不填，Moodle將使用PHP預設的方法來發信。';
