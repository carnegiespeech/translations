...
/**
 * Strings for component 'blog', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
 * @package   blog
...
$string['addnewexternalblog'] = '註冊一外面的部落格';
...
$string['autotags_help'] = '在此輸入一個或多個本地標籤（用英文逗點分隔）。所有從您的外部部落格拷貝到本地部落格的文章都會被自動加上這些標籤';
$string['backupblogshelp'] = '如果開啟此項設定，部落格資料將在網站自動備份時加入備份。';
$string['blockexternalstitle'] = '外部部落格';
...
$string['blogdeleteconfirm'] = '刪除這個部落格嗎？';
...
$string['blogentriesbyuseraboutcourse'] = '由{$a->user}發表的關於{$this->course}的部落格文章';
...
$string['cannotviewuserblog'] = '您沒有閱讀使用者部落格的權限';
$string['configexternalblogcrontime'] = 'Moodle多久檢查一次外部部落格的新文章。';
$string['configmaxexternalblogsperuser'] = '每個使用者可以允許有幾篇外部部落格文章鏈結到他們的Moodle部落格中。';
$string['configuseblogassociations'] = '允許將部落格文章與課程及課程模組關聯。';
$string['configuseexternalblogs'] = '允許用戶指定外部部落格的來源。Moodle會週期性檢查部落格來源中的新文章，將其拷貝到用戶的本地部落格。';
$string['courseblog'] = '課程部落格： {$a}';
$string['courseblogdisable'] = '課程部落格：{$a}';
$string['courseblogs'] = '使用者只有在人們分享一個課程時才能夠檢視部落格';
$string['deleteblogassociations'] = '課程部落格不能使用';
$string['deleteblogassociations_help'] = '如果勾選，那麼部落格文章將不再與這課程或任何課程活動或資源有關連。但部落格文章本身不會被刪除。';
$string['deleteexternalblog'] = '取消這外部部落格的註冊';
$string['deleteotagswarn'] = '您確定要從所有部落格文章以及系統中移除這些標籤？';
$string['description'] = '描述';
$string['description_help'] = '輸入一到兩句話來簡介您的外部部落格的內容。（如果不提供描述，那麼會直接使用您外部部落格所記錄的描述）。';
$string['disableblogs'] = '完全停用部落格系統';
$string['donothaveblog'] = '抱歉，您沒有自己的部落格。';
$string['editentry'] = '編輯部落格文章';
$string['editexternalblog'] = '編輯這個外部部落格';
...
$string['entryupdated'] = '部落格文章更新了';
$string['externalblogcrontime'] = '外部部落格的 cron 排程';
$string['externalblogdeleteconfirm'] = '取消這外部部落格的註冊？';
$string['externalblogdeleted'] = '外部部落格已經取消註冊';
...
$string['filtertags'] = '過濾器的標籤';
$string['filtertags_help'] = '您可以使用此功能來篩選您想要的文章。如果您在這裡指定的標籤（以逗號分隔），那麼只有帶著這些標簽的文章會從外部部落格拷貝過來。';
$string['groupblog'] = '群組部落格： {$a}';
$string['groupblogdisable'] = '群組部落格：{$a}';
$string['groupblogentries'] = '部落格文章和{$a->groupname}的{$a->coursename}相關';
$string['groupblogs'] = '使用者只能夠在人們分享一個群組時檢視部落格';
$string['incorrectblogfilter'] = '不正確的部落格過濾類型';
$string['intro'] = '這個 RSS 內容會自動由一或多個部落格產生。';
$string['invalidgroupid'] = '無效的群組 ID';
$string['invalidurl'] = '這網址無法前往';
$string['linktooriginalentry'] = '鏈結到原初的部落格文章';
$string['maxexternalblogsperuser'] = '每位使用者最多允許使用幾個外部部落格';
$string['mustassociatecourse'] = '如果你想出版給一課程或全體成員看，你必須將這文章與一課程相關聯';
$string['name'] = '名稱';
...
$string['publishtocourse'] = '和您選修同一個課程的使用者';
...
$string['siteblogdisable'] = '網站部落格未啟用';
...
$string['useexternalblogs'] = '啟用外部部落格';
