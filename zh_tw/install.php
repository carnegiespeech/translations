...
/**
 * Strings for component 'install', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
 * @package   install
...
$string['nativemysqlihelp'] = '現在你需要配置大多數Moodle資料要存放的資料庫。<br />
這資料庫必須已經被建立，且有用戶名稱和密碼可以存取它。資料表接首字是選用的。';
$string['nativeoci'] = 'Oracle (native/oci)';
$string['nativeocihelp'] = '現在你需要配置大多數Moodle資料要存放的資料庫。<br />
這資料庫必須已經被建立，且有用戶名稱和密碼可以存取它。它強制使用資料表接首字。';
$string['nativepgsql'] = 'PostgreSQL (native/pgsql)';
$string['nativepgsqlhelp'] = '現在你需要配置大多數Moodle資料要存放的資料庫。<br />
這資料庫必須已經被建立，且有用戶名稱和密碼可以存取它。它強制使用資料表接首字。';
