...
/**
 * Strings for component 'hub', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
 * @package   hub
...
$string['moodleorgregistrationdetail'] = 'MOOCH是主要社群中心伺服器，網址是hub.moodle.org。在MOOCH註冊您的網站可以幫助我們統計Moodle在全世界的使用情形。您可以加入一個郵件列表，它的郵件很少，只是提前提供一些關於安全性修正和Moodle新版本發行的通知。';
$string['moodleorgregistrationdetail2'] = '通過此選項可以將您的Moodle往站在MOOCH(hub.moodle.org)註冊。註冊是免費的。這要做的主要好處事您會被加入一個郵件列表，這個列表訊息不多，只有重要的通知，例如安全警告和Moodle新版本的發行通知。預設情況下，您的資訊不會被公開，也永遠不會被出賣或是轉讓給其他人。收集這些資訊的唯一目的是支援與服務，同時幫助我們建立一個Moodle社群整體統計圖。
您可以選擇將您的網站名稱、國家和URL加入公開的Moodle網站列表中。所新註冊都會被人工審核，然後才加入列表，但只有已經加入過，您就可以隨時更新您的註冊(和您在公開列表中的資訊）。';
...
$string['registeredon'] = '你所註冊的課程集散中心';
$string['registeredsites'] = '已註冊的網站';
$string['registeron'] = '要在Moodle.org Open Community Hub (MOOCH)註冊之前，你的網站必須先在Moodle.org 註冊。';
$string['registeronmoodleorg'] = '在Moodle.org(MOOCH)註冊';
$string['registeronspecifichub'] = '在指定的課程集散中心伺服器註冊';
$string['registersite'] = '在{$a}註冊';
$string['registrationconfirmed'] = '網站註冊已經確認';
$string['registrationconfirmedon'] = '您現在已經在{$a}註冊。您現在可以使用課程管理選單的"發佈"鏈結，發佈課程到這一課程集散中心。';
