...
/**
 * Strings for component 'message', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
 * @package   message
...
$string['contacts'] = '通訊錄';
$string['context'] = '內容';
$string['couldnotfindpreference'] = '無法裝載偏好 {$a}。

你提供到message_send() 的元件和名稱是否符合簡訊提供者的要求。

簡訊提供者必須出現在資料庫，這樣用戶才能配置當他們收到訊息時要如何通知他們。';
$string['defaultmessageoutputs'] = '預設簡訊輸出';
$string['defaults'] = '預設';
$string['deletemessagesdays'] = '多少天前的舊簡訊應當被自動刪除';
$string['disableall'] = '暫時關閉通知';
$string['disableall_help'] = '暫時關閉所有的通知，除了那些被網站管理員標示為"強制的"之外。';
...
$string['errorcallingprocessor'] = '錯誤呼叫以定義的輸出';
$string['errortranslatingdefault'] = '轉譯插件所提供的預設設定有錯誤，請使用系統預設來代替';
$string['forced'] = '強制的';
$string['formorethan'] = '超過';
$string['gotomessages'] = '跳到簡訊';
$string['guestnoeditmessage'] = '訪客不能編輯簡訊選項';
$string['guestnoeditmessageother'] = '訪客不能編輯其他用戶的簡訊選項';
$string['includeblockedusers'] = '包括黑名單';
$string['incomingcontacts'] = '新的聯絡人 ({$a})';
$string['keywords'] = '關鍵字';
$string['keywordssearchresults'] = '搜尋結果: 找到{$a}條簡訊';
$string['keywordssearchresultstoomany'] = '找到多於{$a}條簡訊，請改進你的搜尋。';
$string['loggedin'] = '線上';
...
$string['messagehistoryfull'] = '全部簡訊歷史紀錄';
$string['messagenavigation'] = '簡訊導航：';
$string['messageoutputs'] = '簡訊輸出';
$string['messages'] = '簡訊';
$string['messaging'] = '傳簡訊';
$string['messagingblockednoncontact'] = '{$a}將無法回覆，因為你已經封鎖了非聯絡人。';
$string['messagingdisabled'] = '網站中已禁用簡訊功能，將以電子郵件發送來取代。';
$string['mostrecent'] = '新近的簡訊';
$string['mostrecentconversations'] = '新近的對話';
...
$string['touserdoesntexist'] = '你不能傳送簡訊給一個不存在的用戶(編號{$a})';
