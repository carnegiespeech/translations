...
/**
 * Strings for component 'lesson', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
 * @package   lesson
...
$string['importppt_help'] = '將PowerPoint 2003製作的投影片另存為web頁面，並且使用zip格式壓縮後，用此功能可以將這些頁面匯入到課程中。';
...
$string['pptsuccessfullimport'] = '已經成功地從上傳的PowerPoint簡報檔匯入頁面。';
