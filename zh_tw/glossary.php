...
/**
 * Strings for component 'glossary', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
 * @package   glossary
...
$string['errdeltimeexpired'] = '你不可以刪除這個。超過時間!';
...
$string['modulename_help'] = '詞彙模組能讓使用者建立和維護像是字典一樣的定義列表。無論詞名出現在課程的哪裡，都可以被自動連結到對應的詞目。';
