...
/**
 * Strings for component 'qtype_calculated', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
...
$string['addmoreunitblanks'] = '再增加 {$a} 個單位';
$string['addsets'] = '添加集合';
$string['answerhdr'] = '答案';
...
$string['existingcategory1'] = '將使用一個已經存在的共享資料集';
...
$string['keptlocal1'] = '將使用之前相同的私用資料集';
...
$string['possiblehdr'] = '可能可能的變數，只能出現在試題文字中';
