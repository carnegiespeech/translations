...
/**
 * Strings for component 'choice', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
 * @package   choice
...
$string['modulename_help'] = '在選擇模組中，老師可以提出一個問題，並且給出多個回答選項。';
$string['modulenameplural'] = '意見調查';
$string['moveselectedusersto'] = '移動選出的用戶到.....';
...
$string['numberofuserinpercentage'] = '用戶人數百分比';
$string['option'] = '選項';
$string['page-mod-choice-x'] = '任何票選模組頁面';
$string['pluginadministration'] = '票選(及自由選組)管理';
...
$string['userchoosethisoption'] = '用戶選擇這一選項';
