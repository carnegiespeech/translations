...
/**
 * Strings for component 'enrol_database', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
...
$string['dbhost'] = '資料庫主機';
$string['dbhost_desc'] = '輸入資料庫伺服器IP或網域名稱';
$string['dbname'] = '資料庫名稱';
$string['dbpass'] = '資料庫密碼';
...
$string['newcoursetable_desc'] = '指定一個資料表名稱，它應該包含所有要自動新建的課程。留空表示不創建任何課程。';
