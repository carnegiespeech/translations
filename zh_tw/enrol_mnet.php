...
/**
 * Strings for component 'enrol_mnet', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
 * @package   enrol_mnet
...
$string['error_multiplehost'] = '這個主機上已經存在某個MNet選課插件的實體。 每個主機只能允許有一個實體並且/或「所有主機」共有一個實體也是允許的。';
