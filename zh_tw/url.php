...
/**
 * Strings for component 'url', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
 * @package   url
...
選項可以包括: <br />
* 自動的 - 讓系統依據網址自動為您選擇最佳顯示方式。<br />
* 鑲入的 - 檔案被顯示在Moodle頁面內，有導覽列、檔案說明和任何區塊。<br />
* 強迫下載 - 用戶被提示要下載網址檔案<br />
* 以原視窗開啟 - 只有這網址被顯示在瀏覽器視窗<br />
* 用彈出式視窗開啟 - 網址被顯示在一彈出的小的新視窗中(可用滑鼠調整大小)，而沒有工具列和位址列<br />
* 用框架開啟 - 網址被顯示在一框架上端有導覽列和檔案說明<br />
* 以新視窗開啟 - 網址被顯示在另一新瀏覽器視窗，有工具列和位址列。\';
$string[\'displayselectexplain\'] = \'選擇顯示類型，不幸的，不是所有類型都適合所有的網址。';
$string['externalurl'] = '外部網址';
$string['framesize'] = '架框高度';
$string['invalidstoredurl'] = '不能顯示這一資源，網址無效。';
$string['invalidurl'] = '輸入的網址是無效的';
$string['modulename'] = '網址資源';
$string['modulenameplural'] = '網址資源';
$string['neverseen'] = '從未看過';
...
$string['printheading'] = '顯示網址名稱';
$string['printheadingexplain'] = '在內容之上顯示網址名稱，某些顯示類型可能無法顯示名稱，即使它已被啟動。';
