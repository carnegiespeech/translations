...
/**
 * Strings for component 'theme_magazine', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
...
$string['blockcolor'] = '版塊顏色';
$string['blockcolordesc'] = '版塊頭字體的顏色。';
...
$string['logo'] = '徽章';
$string['logodesc'] = '輸入徽章的網址（比如，http://www.somesite/animage.png），可改變本主題的徽章。預設的徽章是300px寬，80px高。透明的PNG檔效果最好。';
$string['maincolor'] = '主色';
