...
/**
 * Strings for component 'theme_brick', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
 * @package   theme_brick
...
<div class="theme_screenshot">
	...
	<h2 style="padding-top:0.5em;">磚塊</h2>
...
<div class="theme_description">
	...
	<h2>關於</h2>
	<p>磚塊是一個雙列、可變寬的Moodle 2.0主題。您可以在主題設置頁面修改它的配色。</p>

	<h2>調整</h2>
	<p>本主題基於Moodle核心的基本主題和畫布主題構建。如果除了設置裏提供的定製功能以外，您還想做其它修改，我們建議您創建一個新主題，並將本主題、基礎和畫布做爲父主題。這樣這三個核心主題中任意一個的更新都能反映到您的主題上。</p>

	<h2>致謝</h2>
	<p>本主題由NewSchool Learning的John Stabinger編寫和維護。可以通過contact@newschoollearning.com聯繫他。</p>

	<h2>授權</h2>
	<p>Moodle核心提供的所有主題，包括此主題的授權協議都是<a href="http://www.gnu.org/licenses/gpl.html">GNU General Public License</a>。</p>
