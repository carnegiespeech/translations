...
/**
 * Strings for component 'chat', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
 * @package   chat
...
$string['listing_all_sessions'] = '列出所有的對話。';
...
$string['modulename_help'] = '在聊天室模組中，參與者可以透過Web進行實況、同步的討論。與非同步的討論區相比，聊天室完全不同，對於增進了解、深入話題很有幫助。';
...
$string['nopermissiontoseethechatlog'] = '沒有察看聊天室日誌的權限。';
...
$string['sessionstart'] = '聊天對話開始時間：{$a}';
