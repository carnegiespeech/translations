...
/**
 * Strings for component 'question', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
 * @package   question
...
$string['cannotinsertquestioncatecontext'] = '無法插入新試題類別 {$a->cat}，因為不合法的脈絡編號 {$a->ctx}';
...
$string['clearwrongparts'] = '清除不正確的答案';
...
$string['commentormark'] = '做評論或撤銷分數';
$string['comments'] = '評語';
$string['commentx'] = '評語：{$a}';
$string['complete'] = '完成';
$string['contexterror'] = '你應該不會跑到這兒，若你沒有移動一個類別到另一個脈絡。';
$string['copy'] = '從{$a}複製並更改變連結。';
$string['correct'] = '正確';
$string['correctfeedback'] = '給任何正確反應';
$string['created'] = '已建立';
...
$string['exportquestions_help'] = '<p>這個選項允許您從一個類別中將問題全部導出到一個文字檔案中。</p>　
<p>注意很多檔格式都會導致問題的某些資訊丟失，這是因為大錯數格式都無法支援Moodle中問題的全部功能。因此當導出並重新導入問題後，可能它們並不會完全相同。而且有些檔格式是不支持匯出的。</p>
...
$string['howquestionsbehave_help'] = '學生再測驗卷中可以用多種不同方式和試題互動。舉例來說，你傳統上希望學生在每一試題輸入答案，然後提交整份測驗卷，而在這之前沒有東西會被計分或得到任何回饋，這就是"延後回饋"模式。
...
$string['incorrectfeedback'] = '給任何不正確的答案';
...
$string['marks'] = '所有得分';
$string['matcherror'] = '比對可用的得分百分比不符合---此試題不匯入。';
...
$string['notshown'] = '沒被顯示出來的';
$string['notyetanswered'] = '還沒被回答的';
...
$string['partiallycorrectfeedback'] = '給任何部份正確的反應';
...
$string['penaltyforeachincorrecttry'] = '對每一不正確回答的扣分(倒扣)';
$string['penaltyforeachincorrecttry_help'] = '當你的試題是採用"直到答對法"來作答時，學生將會有好幾次嘗試，一直到答對為止，這選項用來控制，每次答錯時要減多少百分比的得分。

扣分是以從該題的配分中扣一定比例的分數來進行。比如，若有一個四選一的選擇題，配分為3分，扣分比例是.33333333，若第一次就答對，可得3分，若第二次才答對，可得2分，若第三次才答對，只能得1分。';
...
$string['questionsrescuedfrom'] = '來自脈絡{$a}的試題被儲存';
...
$string['questionvariant'] = '試題的變化型態';
...
$string['selectaqtypefordescription'] = '選擇一試題類型來看它的說明';
$string['selectcategoryabove'] = '從上方選擇一個類別';
$string['selectquestionsforbulk'] = '選擇試題做批次動作';
$string['settingsformultipletries'] = '設定為多次嘗試';
$string['shareincontext'] = '在{$a}中共享';
$string['showhidden'] = '同時顯示舊的題目';
$string['showmarkandmax'] = '顯示分數與最高分';
$string['showmaxmarkonly'] = '只顯示最高分';
$string['shown'] = '已經顯示';
$string['shownumpartscorrect'] = '顯示正確的答案數';
$string['shownumpartscorrectwhenfinished'] = '一旦試題完成，則顯示正確反應數';
$string['showquestiontext'] = '在試題列表中顯示試題內容';
...
$string['unknowntolerance'] = '不明的容錯類型：{$a}';
...
$string['yougotnright'] = '你有正確的選出 {$a->num}。';
