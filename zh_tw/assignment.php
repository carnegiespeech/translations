...
/**
 * Strings for component 'assignment', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
 * @package   assignment
...
$string['downloadall'] = '下載所有作業的zip檔';
$string['draft'] = '草稿';
$string['due'] = '作業截止日期';
$string['duedate'] = '截止日期';
...
$string['hideintro_help'] = '如果啟用，在"開放時間"還沒到的時候，會隱藏作業敘述，只顯示作業名稱。';
...
$string['page-mod-assignment-submissions'] = '作業模組評分分頁';
...
$string['trackdrafts_help'] = '透過"發送評分請求"按鈕，學生可以透過老師他們已經完成了作業。如果需要，老師可以將作業恢復到草稿狀態（比如，該作業還需進一步寫的更完整）';
