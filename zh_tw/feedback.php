...
/**
 * Strings for component 'feedback', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
 * @package   feedback
...
$string['emailnotification'] = '用電子郵件通知';
$string['email_notification'] = '電子郵件通知';
$string['emailnotification_help'] = '若啟用，回饋提交時，管理員會收到Email通知';
...
$string['modulename_help'] = '回應模組可以建立自訂的問卷調查';
...
$string['show_analysepage_after_submit'] = '在提交之後顯示分析頁面';
...
$string['timeclose'] = '關閉的時間';
$string['timeclose_help'] = '你可以指定一個時間，讓學生不再可以回答問題，若沒有勾選，就是隨時可用。';
$string['timeopen'] = '開放的時間';
$string['timeopen_help'] = '你可以指定一個時間，讓學生可以開始回答問題，若沒有勾選，就是隨時可用。';
$string['typemissing'] = '少了數值"類型"';
$string['update_item'] = '儲存';
$string['url_for_continue'] = '繼續按鈕的網址';
$string['url_for_continue_button'] = '繼續按鈕的網址';
$string['url_for_continue_help'] = '送出回應後，繼續按鈕的目標預設是課程頁面。您可以在這裡指定另一個目標網址。';
