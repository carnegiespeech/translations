...
/**
 * Strings for component 'webservice', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
 * @package   webservice
...
$string['createtokenforuserauto'] = '自動為一用戶建立通行憑證';
...
$string['usernotallowed'] = '此用戶無法使用此服務。首先，您需要在{$a}的許可用戶管理頁面允此用戶使用。';
