...
/**
 * Strings for component 'survey', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
 * @package   survey
...
以下的24個問題是想了解您使用本線上課程的經驗與感覺，沒有所謂對錯的答案； 我們有興趣的是您的觀點與想法。

可以保證的是您的回答會被保密，而且和學期成績絕對無關。
...
$string['collesm4'] = '老師支持';
$string['collesm4short'] = '老師支持';
...
$string['summary'] = '總結';
$string['surveycompleted'] = '您已經完成本問卷調查，以下顯示您的回答和全班平均數的比較';
...
*建構主義的線上學習環境調查(Constructivist On-line L';
