...
/**
 * Strings for component 'gradingform_rubric', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
...
$string['alwaysshowdefinition'] = '允許用戶與覽用於這模組的評分規程(rubric)，否則評分規程只能在評分完後才看得見。';
...
$string['levelempty'] = '點選來編輯層次';
$string['name'] = '名稱';
$string['needregrademessage'] = '在這學生被評分之後，評分規程已經被更改。這學生不能看到這評分規程，除非你核對這評分規程並更新分數。';
...
$string['rubricnotcompleted'] = '評分規程尚未完成';
...
$string['showscorestudent'] = '向學生顯示每一層次的給分';
$string['showscoreteacher'] = '向評分老師顯示每一層次的給分';
$string['sortlevelsasc'] = '各層次的排序方式：';
