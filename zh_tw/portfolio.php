...
/**
 * Strings for component 'portfolio', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
 * @package   portfolio
...
$string['activeportfolios'] = '可用的作品選集';
$string['addalltoportfolio'] = '全部匯出到作品選集';
$string['addnewportfolio'] = '增加一個新的作品選集';
$string['addtoportfolio'] = '匯出到作品選集';
$string['alreadyalt'] = '已經在匯出-請點選此處解析這次傳送';
$string['alreadyexporting'] = '您這次工作階段已經有一個活動的作品選集匯出。在繼續之前，您必須完成這一匯出，或者取消它。您要繼續完成匯出嗎？（"否"會取消匯出）';
...
$string['cannotsetvisible'] = '無法設定為可見的 - 因為設定錯誤，此插件已被完全停用。';
$string['commonportfoliosettings'] = '共同作品選集設定';
$string['commonsettingsdesc'] = '<p>一次傳送要花費的時間被視作"適中"還是"大量"決定了用戶是否可以等待傳送結束。</p><p>小於"適中"門檻的檔案會立刻被傳送，不會詢問用戶。而"中度"和"大量"的傳送會先給用戶選項，並警告他們這可能會耗掉一些時間。</p><p>另外，某些作品選集插件會完全忽略此選項，並強制所有轉移必須要排隊。</p>';
$string['configexport'] = '設定匯出的資料';
$string['configplugin'] = '配置作品選集插件';
$string['configure'] = '設定';
$string['confirmcancel'] = '您確定要取消本次的匯出？';
$string['confirmexport'] = '請確認本次匯出';
$string['confirmsummary'] = '您的匯出的摘要';
$string['continuetoportfolio'] = '繼續瀏覽您的作品選集';
$string['deleteportfolio'] = '刪除作品選集實例';
$string['destination'] = '目的地';
$string['disabled'] = '抱歉，本站沒有啟用作品選集匯出功能';
...
$string['enabled'] = '啟用作品選集';
$string['enableddesc'] = '啟用後，管理員可以設定提供用戶匯出內容的遠端系統。';
$string['err_uniquename'] = '作品選集的名稱必須是唯一的(每一插件)。';
$string['exportalreadyfinished'] = '作品選集匯出完成！';
$string['exportalreadyfinisheddesc'] = '作品選集匯出完成！';
$string['exportcomplete'] = '作品選集匯出完成！';
$string['exportedpreviously'] = '先前的匯出';
$string['exportexceptionnoexporter'] = '一個工作階段 portfolio_export_exception 被拋出，也沒有匯出目標。';
$string['exportexpired'] = '作品選集匯出逾時';
$string['exportexpireddesc'] = '您曾反覆嘗試匯出某些資訊，或者啟動一個空的匯出。正確的操作是，退回到原始位置並重新開始。發生這種情況一般是因為再會出結束後，您按到了返回按拗，或者是儲存了一個不正確的網址。';
$string['exporting'] = '匯出到作品選集';
$string['exportingcontentfrom'] = '正在從{$a}匯出內容';
$string['exportingcontentto'] = '正在匯出內容到{$a}';
$string['exportqueued'] = '作品選集匯出已經順利排隊等待轉移';
$string['exportqueuedforced'] = '作品選集匯出已經順利排隊等待匯出(遠端系統已經執行排隊的轉移)';
$string['failedtopackage'] = '無法找到檔案來打包';
$string['failedtosendpackage'] = '將您的資料發送往您選擇的作品選集儲存系統時出錯：原始錯誤訊息是{$a}';
...
$string['format_leap2a'] = 'Leap2A 作品選集格式';
...
<p>因為設定錯誤，一些作品選集插件被自動停用，這表示用戶現在不能使用這些插件匯出內容到這些作品選集。</p>

<p>被停用的作品選集插件實例的清單有：</p>

{$a->htmlist}

<p>請瀏覽 <a href="{$a->fixurl}">作品選集設定頁面</a>，儘快修正此問題。</p>';
$string['insanebodysmall'] = '您好！因為您是{$a->sitename}的管理員，所以您會收到此訊息。因為設定錯誤，一些作品選集插件被自動停用，這表示用戶現在不能使用這些插件匯出內容到作品選集。請瀏覽 {$a->fixurl} ，儘快修正此問題。';
$string['insanesubject'] = '某些作品選集已經自動被停用';
$string['instancedeleted'] = '已成功刪除作品選集';
$string['instanceismisconfigured'] = '作品選集設定不正確，略過。錯誤是：{$a}';
$string['instancenotdelete'] = '無法刪除作品選集';
$string['instancenotsaved'] = '無法儲存作品選集選集';
$string['instancesaved'] = '作品選集儲存成功';
...
$string['invalidinstance'] = '找不到這個作品選集實例';
...
$string['manageportfolios'] = '管理作品選集';
$string['manageyourportfolios'] = '管理您的作品選集';
$string['mimecheckfail'] = '這作品選集插件{$a->plugin}不支援 {$a->mimetype}類型';
...
$string['moderatefilesizethreshold'] = '轉移時適度的檔案大小';
$string['moderatefilesizethresholddesc'] = '檔案大小超過這一界線將會花較多時間來轉移';
$string['multipleinstancesdisallowed'] = '試圖建立一個插件的實例，但它不允許多個實體（{$a}）';
$string['mustsetcallbackoptions'] = '您必須在 portfolio_add_button 的建構子或使用 set_callback_options 的方法設定呼叫選項';
$string['noavailableplugins'] = '抱歉，但是這裡沒有可用的作品選集讓你去匯出';
...
$string['nocommonformats'] = '呼叫的位置 {$a->location} 和可用的作品選集插件之間沒有共同的格式(呼叫者支援{$a->formates}）';
$string['noinstanceyet'] = '還沒有被選擇';
$string['nologs'] = '沒有日誌檔可以顯示!';
$string['nomultipleexports'] = '抱歉，但作品選集的目的地({$a->plugin}）不支援同時進行多個匯出。請<a href="{$a->link}">先完成目前的工作</a>再重新嘗試';
...
$string['notyours'] = '你正試著還原一個作品選集的匯出檔，但它不是屬於你的。';
$string['nouploaddirectory'] = '無法建立一暫時目錄來打包你的資料';
$string['off'] = '啟用但隱藏';
$string['on'] = '啟用且可看見';
$string['plugin'] = '作品選集插件';
$string['plugincouldnotpackage'] = '為匯出而打包您的資料時出錯：原始錯誤是{$a}';
$string['pluginismisconfigured'] = '作品選集插件設定錯誤，跳過。錯誤是：{$a}';
$string['portfolio'] = '作品選集';
$string['portfolios'] = '作品選集';
...
$string['singleinstancenomultiallowed'] = '只有一個單一作品選集插件實例是可用的，它不支援每個工作階段的多次匯出，並且這兒已經有一個處於活動狀態的匯出在這工作階段中使用這插件！';
$string['somepluginsdisabled'] = '有些作品選集插件整個被關閉，因為它們若不是設定錯誤，就是倚賴其他東西，它是：';
$string['sure'] = '你確定要刪除"{$a}"？這動作無法復原。';
$string['thirdpartyexception'] = '作品選集匯出時擲出了一個第三方異常（{$a}）。已經捕捉到並重新拋出，但這個一定要修復';
