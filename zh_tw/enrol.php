...
/**
 * Strings for component 'enrol', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
 * @package   enrol
...
$string['errorenrolcohort'] = '在此課程中建立班級同步選課實例時，發生錯誤';
$string['errorenrolcohortusers'] = '在這一課程中為班級成員進行選修時，發生錯誤';
