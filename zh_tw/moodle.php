...
/**
 * Strings for component 'moodle', language 'zh_tw', branch 'MOODLE_22_STABLE'
 *
 * @package   moodle
...
$string['autosubscribeyes'] = '是：當我張貼發表時，就自動訂閱該討論區';
$string['availability'] = '可用性';
$string['availability_help'] = '這個設定決定這課程是否出現在課程列表中。教師和管理者以外的其他用戶都不能進入此課程。';
...
$string['category_help'] = '這個設定值決定此課程將出現在課程清單的那一類別中。';
...
$string['commentincontext'] = '在場景中尋找此評論';
$string['comments'] = '評論';
$string['commentsnotenabled'] = '評論功能未啟用';
$string['commentsrequirelogin'] = '登入後才能檢視評論內容';
...
$string['coursehelpnewsitemsnumber'] = '此設置決定課程頁面上的右側最新消息區塊出現幾則最新消息(如果設定為“0”，則最新消息區塊將不會顯示)。';
$string['coursehelpnumberweeks'] = '課程首頁中顯示的星期/主題個數。';
...
$string['courselegacyfiles_help'] = '這設定提供Moodle 1.9或更早版本相容的課程檔案區。課程所有參與者允許存取本區所有檔案(不管您是否有連結它們)，沒有辦法知道這些檔案在Moodle中是否有使用到。如果您使用這檔案區儲存課程資料，您可能曝露您自己隱私及產生資安問題，以及備份時、課程匯入時、內容分享或重複使用時遺失檔案。所以建議您不要使用舊版檔案區，除非您真的知道您在做什麼。下列連結提供更多資訊，這一切將告訴你一些更好的方法來管理Moodle 2的檔案。';
...
$string['deletecheckfull'] = '您真的確定要徹底刪除{$a}嗎?';
...
$string['duplicate'] = '複製';
$string['duplicateconfirm'] = '您確定要複製 {$a->modtype} “{$a->modname}”嗎？';
$string['duplicatecontcourse'] = '回到課程';
$string['duplicatecontedit'] = '編輯新的副本';
$string['duplicatenosupport'] = '不能複製活動“{$a->modname}”，因為{$a->modtype}模組不支援備份和還原。';
$string['duplicatesuccess'] = '{$a->modtype} “{$a->modname}” 已經成功複製了';
$string['duplicatinga'] = '正在複製：{$a}';
...
$string['entries'] = '條目';
$string['error'] = '錯誤';
$string['errortoomanylogins'] = '抱歉，您已經超過允許的登入嘗試次數。請重新啟動您的瀏覽器。';
...
$string['expirynotifystudents_help'] = '如果設定了修課日程，那麼這個設定將會決定學生在即將被退選時，是否會收到 email 通知。';
$string['expirythreshold'] = '期滿前幾天提醒';
$string['expirythreshold_help'] = '如果設定了修課日程，那麼這個設定將決定系統在學生被退選的幾天前發出通知。';
...
$string['failedloginattemptsall'] = '帳號{$a->accounts}共有{$a->attempts}次失敗的登入';
$string['feedback'] = '回饋';
$string['file'] = '檔案';
...
$string['forcedmodeinbrackets'] = '{$a}(強制模式)';
...
$string['hidetopicfromothers'] = '隱藏主題';
$string['hideweekfromothers'] = '隱藏星期';
$string['hits'] = '點閱次數';
...
$string['local'] = '本地';
$string['localplugindeleteconfirm'] = '您正要完全刪除本地端外掛"{$a}"。這將從資料庫刪除與它有關的所有資料。您確定要繼續嗎？';
...
$string['loginusing'] = '請使用您的帳號和密碼進行登入';
$string['logout'] = '登出';
...
$string['maxnumberweeks'] = '星期/主題的最大數量';
$string['maxnumberweeks_desc'] = '這個選項決定了課程設定中「『星期/主題』數量」的最大值。';
...
$string['moduledeleteconfirm'] = '您正要完全刪除“{$a}”模組，這將會把這個運作中的模組的所有相關資料全部刪除。您確定要繼續執行嗎？';
$string['moduledeletefiles'] = '所有與模組“{$a->module}”相關的資料已從資料庫中刪除。為了要完整刪除(並防止模組自己重新安裝)，您應該現在就從您的伺服器中刪除{$a->directory}這個目錄。';
...
$string['noteuserschangednonetocourse'] = '注意：當還原用戶資料(活動紀錄、檔案或訊息)時，課程用戶也必須還原回去。已經幫您修改設定。';
$string['nothingnew'] = '自從您上次登入以來尚無新東西';
...
$string['notifyloginfailuresmessageend'] = '您可以在{$a}/course/log.php?id=1&chooselog=1&modid=site_errors看這些日誌。';
...
$string['opentoguests'] = '允許訪客使用';
$string['optional'] = '可選的';
$string['options'] = '選項';
$string['order'] = '次序';
$string['orphanedactivities'] = '孤立無關的活動';
$string['other'] = '其他';
$string['outline'] = '概要';
...
$string['profile'] = '簡歷';
$string['profilenotshown'] = '直到這個人至少選修一門課後，個人簡歷描述才會顯示。';
...
$string['screenreaderuse_help'] = '若設定為是，系統將提供更可親性的介面，例如聊天室。';
...
$string['searchhelp'] = '您可以使用多關鍵字搜尋。<br />word: 搜尋任何包含該關鍵字的內容。<br />+word: 只有準確符合關鍵字才可以。<br />-word: 結果中不含該關鍵詞。';
...
$string['showdescription'] = '在課程頁顯示描述';
$string['showdescription_help'] = '啟用後，上述的簡介/敘述將會顯示在課程頁面，約在「活動/資源」連結的下方。';
...
$string['showtopicfromothers'] = '顯示主題';
$string['showweekfromothers'] = '顯示星期';
$string['since'] = '自從';
...
$string['userselectorsearchanywhere'] = '在使用者姓名的任意位置搜尋';
$string['usersnew'] = '新用戶';
