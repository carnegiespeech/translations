...
$string['criteriagradenote'] = 'Tenga en cuenta que actualizar aquí la calificación requerida no actualizará la calificación anterior del actual curso.';
...
$string['deletecompletiondata'] = 'Eliminar información sobre finalización';
...
$string['graderequired'] = 'Calificación necesaria';
$string['gradexrequired'] = 'necesario {$a}';
