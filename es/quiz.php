...
$string['cannotstartgradesmismatch'] = 'No se puede iniciar un intento en este cuestionario. Este cuestionario está configurado para ser calificado fuera de {$a->grade}, pero ninguna de las preguntas del cuestionario tienene calificación. Esto se puede solucionar en la página \'Editar cuestionario\'.';
...
$string['missingquestion'] = 'Parece que no existe esta progunta';
...
$string['notyetviewed'] = 'Aún no se visualizado';
