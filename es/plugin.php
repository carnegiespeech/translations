...
/**
 * Strings for component 'plugin', language 'es', branch 'MOODLE_22_STABLE'
 *
 * @package   plugin
...
$string['status_upgrade'] = 'Se actualizará';
$string['status_uptodate'] = 'Actualizado';
...
$string['type_gradingform'] = 'Método de calificación avanzada';
$string['type_gradingform_plural'] = 'Métodos de calificación avanzada';
$string['type_local'] = 'Extensión (plugin) local';
$string['type_local_plural'] = 'Extensiones (plugins) locales';
$string['type_message'] = 'Procesador de mensaje';
$string['type_message_plural'] = 'Procesos de mensajería';
...
$string['type_tool_plural'] = 'Herramientas admin';
