...
/**
 * Strings for component 'condition', language 'vi', branch 'MOODLE_22_STABLE'
 *
 * @package   condition
...
$string['showavailability'] = 'Trước khi hoạt động được truy cập';
$string['showavailability_hide'] = 'Ẩn hoàn toàn hoạt động';
$string['userrestriction_hidden'] = 'Hạn chế (hoàn toàn ẩn, không có thông điệp):‘{$a}’';
