...
/**
 * Strings for component 'grades', language 'vi', branch 'MOODLE_22_STABLE'
 *
 * @package   grades
...
$string['aggregatesubcats'] = 'Gộp bao gồm các tiểu mục';
$string['aggregatesubcats_help'] = 'Thiết lập này xác định liệu điểm trong các tiểu mục có được bao gồm trong phép gộp.';
...
$string['warningexcludedsum'] = 'Nguy hiểm: loại trừ điểm không tương thích với phép gộp tổng.';
$string['weight'] = 'khối';
$string['weights'] = 'Khối';
