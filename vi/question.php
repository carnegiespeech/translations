...
/**
 * Strings for component 'question', language 'vi', branch 'MOODLE_22_STABLE'
 *
 * @package   question
...
$string['orphanedquestionscategory'] = 'Các câu hỏi được lưu từ những danh mục bị xóa';
$string['orphanedquestionscategoryinfo'] = 'Đôi khi, điển hình do lỗi phần mềm cũ, các câu hỏi có thể tồn đọng trong CSDL mặc dù danh mục câu hỏi tương ứng đã bị xóa. Dĩ nhiên, điều này không nên xảy ra, nó đã xảy ra trong quá khứ trên trang này. Danh mục này đã được tạo tự động, và các câu hỏi độc lập được chuyển đến đây vì vậy bạn có thể quản lí chúng. Chú ý bất kì hình ảnh hay tệp phương tiện nào được dùng bởi các câu hỏi này có lẽ đã bị mất.';
