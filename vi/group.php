...
/**
 * Strings for component 'group', language 'vi', branch 'MOODLE_22_STABLE'
 *
 * @package   group
...
$string['groupmembersonly'] = 'Chỉ hiện hữu với các thành viên nhóm';
$string['groupmembersonlyerror'] = 'Xin lỗi, bạn phải là thành viên của ít nhất một nhóm được dùng trong hoạt động này.';
$string['groupmembersonly_help'] = 'Nếu ô chọn này được chọn, hoạt động (hay tài nguyên) sẽ chỉ hiện hữu với học viên được phân bổ vào các nhóm thuôc nhóm được chọn.';
