...
$string['error_emptyquizid'] = 'يوجد خطأ في هذه الكتلة الان: تحتاج اختيار الامتحان الذي ترغب في عرض نتائجة.';
$string['error_emptyquizrecord'] = 'يوجد خطأ في هذه الكتلة الان: يبدو أن الامتحان المختار غير موجود في قاعدة البيانات';
$string['error_nogroupsexist'] = 'يوجد خطأ في هذه الكتلة الآن: تم إعدادها لعرض الدرجات لوضع المجموعات، ولكن لم يتم تعريف مجموعات في المقرر الدراسي.';
