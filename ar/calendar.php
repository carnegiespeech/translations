...
$string['pref_persistflt_help'] = 'عند تفعيل هذا الخيار، سيتذكر مودل إعدادات مرشح الأحداث الأخيرة ويستعيدها بشكل تلقائي عن كل تسجيل دخول.';
...
$string['repeatweeksl'] = 'كرر أسبوعياً، منشئاً بالكامل هذا العدد';
