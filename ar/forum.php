...
$string['blockafter'] = 'عتبة تفعيل المنع';
$string['blockafter_help'] = 'يمكن أن يتم تحديد العدد الأعظم لمشاركات الطلاب في المنتدى في فترة زمنية محددة. المستخدمون الذين يتمتعون بصلاحية  mod/forum:postwithoutthrottling هم كثال على تحديد المشاركات';
$string['blockperiod'] = 'فترة المنع الزمنية';
$string['blockperioddisabled'] = 'لا تمنع';
$string['blockperiod_help'] = 'يمكن أن يتم الحد من مشاركات الطلاب بعدد محدد ضمن المنتدى في فترة زمنية محددة. المستخدمون الذين يتمتعون بصلاحية  mod/forum:postwithoutthrottling هم كثال على تحديد المشاركات';
...
$string['forumintro'] = 'التعريف بالمنتدى';
$string['forum:managesubscriptions'] = 'إدارة الاشتراكات';
...
$string['subscriptiondisabled'] = 'الاشتراك معطَّل';
...
$string['warnafter'] = 'عتبة التنبه';
$string['warnafter_help'] = 'يجب أن يتم تنبيه الطالب إلى العدد المحدد المسموح لمشاركاته في فترة زمنية محدد ضمن هذا المنتدى. يتم تحديد هذا الإعداد بعد أن يتحدد عدد المشاركات الأعظمي للطالب. المستخدمون الذين يتمتعون بسماحية mod/forum:postwithoutthrottling أفضل مثال على تحديد المشاركات';
