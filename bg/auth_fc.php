...
/**
 * Strings for component 'auth_fc', language 'bg', branch 'MOODLE_22_STABLE'
 *
 * @package   auth_fc
...
$string['auth_fcpasswd'] = 'Парола за горната потребителска регистрация';
$string['auth_fcpasswd_key'] = 'Парола';
$string['auth_fcuserid'] = 'Идентификатор на потребител на FirstClass сървъра, имащ \'Subadministrator\' привилегията.';
$string['pluginname'] = 'Използване на FirstClass сървър';
