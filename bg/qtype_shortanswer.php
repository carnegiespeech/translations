...
/**
 * Strings for component 'qtype_shortanswer', language 'bg', branch 'MOODLE_22_STABLE'
 *
...
$string['addmoreanswerblanks'] = 'Празни места за още {no} отговори';
...
$string['pluginnameediting'] = 'Редактиране на въпрос - кратък отговор';
